...
{
public:
	struct FButtonStyle                           ButtonStyle;                                       // 0x0030(0x04A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UButtonWidgetStyle) == 0x0004D0, "Wrong size on UButtonWidgetStyle");
...
{
public:
	struct FCheckBoxStyle                         CheckBoxStyle;                                     // 0x0030(0x0A50)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCheckBoxWidgetStyle) == 0x000A80, "Wrong size on UCheckBoxWidgetStyle");
...
{
public:
	struct FComboBoxStyle                         ComboBoxStyle;                                     // 0x0030(0x0740)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboBoxWidgetStyle) == 0x000770, "Wrong size on UComboBoxWidgetStyle");
...
{
public:
	struct FComboButtonStyle                      ComboButtonStyle;                                  // 0x0030(0x0700)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UComboButtonWidgetStyle) == 0x000730, "Wrong size on UComboButtonWidgetStyle");
...
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0030(0x0F00)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBoxWidgetStyle) == 0x000F30, "Wrong size on UEditableTextBoxWidgetStyle");
...
{
public:
	struct FEditableTextStyle                     EditableTextStyle;                                 // 0x0030(0x03E0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextWidgetStyle) == 0x000410, "Wrong size on UEditableTextWidgetStyle");
...
{
public:
	struct FProgressBarStyle                      ProgressBarStyle;                                  // 0x0030(0x0340)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UProgressWidgetStyle) == 0x000370, "Wrong size on UProgressWidgetStyle");
...
{
public:
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0030(0x09A0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBarWidgetStyle) == 0x0009D0, "Wrong size on UScrollBarWidgetStyle");
...
{
public:
	struct FScrollBoxStyle                        ScrollBoxStyle;                                    // 0x0030(0x0450)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UScrollBoxWidgetStyle) == 0x000480, "Wrong size on UScrollBoxWidgetStyle");
...
{
public:
	struct FSpinBoxStyle                          SpinBoxStyle;                                      // 0x0030(0x05A0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USpinBoxWidgetStyle) == 0x0005D0, "Wrong size on USpinBoxWidgetStyle");
...
{
public:
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0030(0x0540)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTextBlockWidgetStyle) == 0x000570, "Wrong size on UTextBlockWidgetStyle");
