...
// Function Foliage.FoliageType.SetCullDistance
// 0x0008 (0x0008 - 0x0000)
struct FoliageType_SetCullDistance final
{
public:
	float                                         MinCullDistance;                                   // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxCullDistance;                                   // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FoliageType_SetCullDistance) == 0x000004, "Wrong alignment on FoliageType_SetCullDistance");
static_assert(sizeof(FoliageType_SetCullDistance) == 0x000008, "Wrong size on FoliageType_SetCullDistance");
static_assert(offsetof(FoliageType_SetCullDistance, MinCullDistance) == 0x000000, "Member 'FoliageType_SetCullDistance::MinCullDistance' has a wrong offset!");
static_assert(offsetof(FoliageType_SetCullDistance, MaxCullDistance) == 0x000004, "Member 'FoliageType_SetCullDistance::MaxCullDistance' has a wrong offset!");
