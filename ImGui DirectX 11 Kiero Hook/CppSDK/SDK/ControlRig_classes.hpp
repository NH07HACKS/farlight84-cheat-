...
{
public:
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreInitializeDelegate;   // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostInitializeDelegate;  // 0x00D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPreEvaluateDelegate;     // 0x00E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UControlRigComponent* Component)> OnPostEvaluateDelegate;    // 0x00F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UControlRig*                            ControlRig;                                        // 0x0100(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UControlRigComponent) == 0x000108, "Wrong size on UControlRigComponent");
static_assert(offsetof(UControlRigComponent, OnPreInitializeDelegate) == 0x0000C0, "Member 'UControlRigComponent::OnPreInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostInitializeDelegate) == 0x0000D0, "Member 'UControlRigComponent::OnPostInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreEvaluateDelegate) == 0x0000E0, "Member 'UControlRigComponent::OnPreEvaluateDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostEvaluateDelegate) == 0x0000F0, "Member 'UControlRigComponent::OnPostEvaluateDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x000100, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
...
static_assert(sizeof(UControlRigLayerInstance) == 0x0002B0, "Wrong size on UControlRigLayerInstance");
...
static_assert(sizeof(UControlRigSequencerAnimInstance) == 0x0002C0, "Wrong size on UControlRigSequencerAnimInstance");
