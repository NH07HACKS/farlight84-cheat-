...
static_assert(sizeof(UEnhancedInputComponent) == 0x000178, "Wrong size on UEnhancedInputComponent");
...
public:
	...
	uint8                                         Pad_4A8[0x160];                                    // 0x04A8(0x0160)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x000608, "Wrong size on UEnhancedPlayerInput");
...
public:
	...
	ETriggerTypeEx GetTriggerType() const;
...
static_assert(sizeof(UInputTriggerChordBlocker) == 0x000050, "Wrong size on UInputTriggerChordBlocker");
