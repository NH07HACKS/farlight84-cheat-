...
public:
	...
	TMulticastInlineDelegate<void(const struct FAppleImageUtilsImageConversionResult& ConversionResult)> OnSuccess; // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FAppleImageUtilsImageConversionResult& ConversionResult)> OnFailure; // 0x0048(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy) == 0x000090, "Wrong size on UAppleImageUtilsBaseAsyncTaskBlueprintProxy");
static_assert(offsetof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy, OnSuccess) == 0x000038, "Member 'UAppleImageUtilsBaseAsyncTaskBlueprintProxy::OnSuccess' has a wrong offset!");
...
static_assert(offsetof(UAppleImageUtilsBaseAsyncTaskBlueprintProxy, ConversionResult) == 0x000068, "Member 'UAppleImageUtilsBaseAsyncTaskBlueprintProxy::ConversionResult' has a wrong offset!");
