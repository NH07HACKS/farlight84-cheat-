...
{
public:
	class UGeometryCacheComponent*                GeometryCacheComponent;                            // 0x02D8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AGeometryCacheActor) == 0x0002E0, "Wrong size on AGeometryCacheActor");
static_assert(offsetof(AGeometryCacheActor, GeometryCacheComponent) == 0x0002D8, "Member 'AGeometryCacheActor::GeometryCacheComponent' has a wrong offset!");
...
public:
	...
	float                                         ElapsedTime;                                       // 0x06A8(0x0004)(Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
