...
// Function DLSSBlueprint.DLSSLibrary.GetCurrentDesiredResolutionFraction
// 0x0004 (0x0004 - 0x0000)
struct DLSSLibrary_GetCurrentDesiredResolutionFraction final
{
public:
	float                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DLSSLibrary_GetCurrentDesiredResolutionFraction) == 0x000004, "Wrong alignment on DLSSLibrary_GetCurrentDesiredResolutionFraction");
static_assert(sizeof(DLSSLibrary_GetCurrentDesiredResolutionFraction) == 0x000004, "Wrong size on DLSSLibrary_GetCurrentDesiredResolutionFraction");
static_assert(offsetof(DLSSLibrary_GetCurrentDesiredResolutionFraction, ReturnValue) == 0x000000, "Member 'DLSSLibrary_GetCurrentDesiredResolutionFraction::ReturnValue' has a wrong offset!");
...
// Function DLSSBlueprint.DLSSLibrary.SetCurrentDesiredResolutionFraction
// 0x0004 (0x0004 - 0x0000)
struct DLSSLibrary_SetCurrentDesiredResolutionFraction final
{
public:
...
static_assert(alignof(DLSSLibrary_SetCurrentDesiredResolutionFraction) == 0x000004, "Wrong alignment on DLSSLibrary_SetCurrentDesiredResolutionFraction");
static_assert(sizeof(DLSSLibrary_SetCurrentDesiredResolutionFraction) == 0x000004, "Wrong size on DLSSLibrary_SetCurrentDesiredResolutionFraction");
static_assert(offsetof(DLSSLibrary_SetCurrentDesiredResolutionFraction, Fraction) == 0x000000, "Member 'DLSSLibrary_SetCurrentDesiredResolutionFraction::Fraction' has a wrong offset!");
