...
class IForcePointDataProvider final
{
public:
...
static_assert(alignof(IForcePointDataProvider) == 0x000001, "Wrong alignment on IForcePointDataProvider");
static_assert(sizeof(IForcePointDataProvider) == 0x000001, "Wrong size on IForcePointDataProvider");

// Class CascadeExtensionPlugin.MeshDataProvider
// 0x0000 (0x0000 - 0x0000)
class IMeshDataProvider final
{
public:
...
static_assert(alignof(IMeshDataProvider) == 0x000001, "Wrong alignment on IMeshDataProvider");
static_assert(sizeof(IMeshDataProvider) == 0x000001, "Wrong size on IMeshDataProvider");

// Class CascadeExtensionPlugin.ParticleDataProvider
// 0x0000 (0x0000 - 0x0000)
class IParticleDataProvider final
{
public:
...
static_assert(alignof(IParticleDataProvider) == 0x000001, "Wrong alignment on IParticleDataProvider");
static_assert(sizeof(IParticleDataProvider) == 0x000001, "Wrong size on IParticleDataProvider");
...
{
public:
	int32                                         ModuleID;                                          // 0x0380(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TimeLeftUntilDestruction;                          // 0x0384(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                BaseScale;                                         // 0x0388(0x000C)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UParticleDecalComponent) == 0x0003A0, "Wrong size on UParticleDecalComponent");
static_assert(offsetof(UParticleDecalComponent, ModuleID) == 0x000380, "Member 'UParticleDecalComponent::ModuleID' has a wrong offset!");
static_assert(offsetof(UParticleDecalComponent, TimeLeftUntilDestruction) == 0x000384, "Member 'UParticleDecalComponent::TimeLeftUntilDestruction' has a wrong offset!");
static_assert(offsetof(UParticleDecalComponent, BaseScale) == 0x000388, "Member 'UParticleDecalComponent::BaseScale' has a wrong offset!");
