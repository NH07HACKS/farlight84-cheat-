...
// Enum Landscape.ELandscapeLayerPlatform
// NumValues: 0x0005
enum class ELandscapeLayerPlatform : uint8
{
	LSLP_Default                             = 0,
	LSLP_ALL                                 = 0,
	LSLP_PCOnly                              = 1,
...
public:
	...
	ELandscapeLayerPlatform                       CookPlatform;                                      // 0x001A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FLandscapeLayer, CookPlatform) == 0x00001A, "Member 'FLandscapeLayer::CookPlatform' has a wrong offset!");
...
public:
	...
	bool                                          bUseLightmapPerPixelPerInstance;                   // 0x0043(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShadowMapBakeOnly;                                // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_45[0x3];                                       // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         OverrideCVarMinVertsToSplitNode;                   // 0x0048(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGrassVariety) == 0x000008, "Wrong alignment on FGrassVariety");
static_assert(sizeof(FGrassVariety) == 0x000050, "Wrong size on FGrassVariety");
...
static_assert(offsetof(FGrassVariety, bUseLightmapPerPixelPerInstance) == 0x000043, "Member 'FGrassVariety::bUseLightmapPerPixelPerInstance' has a wrong offset!");
static_assert(offsetof(FGrassVariety, bShadowMapBakeOnly) == 0x000044, "Member 'FGrassVariety::bShadowMapBakeOnly' has a wrong offset!");
static_assert(offsetof(FGrassVariety, OverrideCVarMinVertsToSplitNode) == 0x000048, "Member 'FGrassVariety::OverrideCVarMinVertsToSplitNode' has a wrong offset!");
...
// 0x000C (0x000C - 0x0000)
struct FLandscapeSplineSegmentSurfaceName final
{
public:
	ELandscapeSplineSegmentSurface                Type;                                              // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FLandscapeSplineSegmentSurfaceName) == 0x000004, "Wrong alignment on FLandscapeSplineSegmentSurfaceName");
static_assert(sizeof(FLandscapeSplineSegmentSurfaceName) == 0x00000C, "Wrong size on FLandscapeSplineSegmentSurfaceName");
static_assert(offsetof(FLandscapeSplineSegmentSurfaceName, Type) == 0x000000, "Member 'FLandscapeSplineSegmentSurfaceName::Type' has a wrong offset!");
static_assert(offsetof(FLandscapeSplineSegmentSurfaceName, Name) == 0x000004, "Member 'FLandscapeSplineSegmentSurfaceName::Name' has a wrong offset!");
