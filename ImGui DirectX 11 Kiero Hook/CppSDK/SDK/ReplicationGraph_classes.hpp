...
public:
	...
	TMap<class UNetConnection*, class UNetReplicationGraphConnection*> ConnectionToConnectionManager; // 0x0058(0x0050)(NativeAccessSpecifierPublic)
	uint8                                         Pad_A8[0x40];                                      // 0x00A8(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UReplicationGraphNode*>          GlobalGraphNodes;                                  // 0x00E8(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UReplicationGraphNode*>          PrepareForReplicationNodes;                        // 0x00F8(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UReplicationGraphNode*>          PostReplicateNodes;                                // 0x0108(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_118[0x480];                                    // 0x0118(0x0480)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UNetConnection*, struct FClassExtraReplicatedInfo> ConnectionInfos;                   // 0x0598(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UReplicationGraph) == 0x000620, "Wrong size on UReplicationGraph");
...
static_assert(offsetof(UReplicationGraph, ConnectionToConnectionManager) == 0x000058, "Member 'UReplicationGraph::ConnectionToConnectionManager' has a wrong offset!");
static_assert(offsetof(UReplicationGraph, GlobalGraphNodes) == 0x0000E8, "Member 'UReplicationGraph::GlobalGraphNodes' has a wrong offset!");
static_assert(offsetof(UReplicationGraph, PrepareForReplicationNodes) == 0x0000F8, "Member 'UReplicationGraph::PrepareForReplicationNodes' has a wrong offset!");
static_assert(offsetof(UReplicationGraph, PostReplicateNodes) == 0x000108, "Member 'UReplicationGraph::PostReplicateNodes' has a wrong offset!");
static_assert(offsetof(UReplicationGraph, ConnectionInfos) == 0x000598, "Member 'UReplicationGraph::ConnectionInfos' has a wrong offset!");
...
{
public:
	class UReplicationGraphNode_GridSpatialization2D* GridNode;                                      // 0x0618(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UReplicationGraphNode_ActorList*        AlwaysRelevantNode;                                // 0x0620(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FConnectionAlwaysRelevantNodePair> AlwaysRelevantForConnectionList;                // 0x0628(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         ActorsWithoutNetConnection;                        // 0x0638(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBasicReplicationGraph) == 0x000650, "Wrong size on UBasicReplicationGraph");
static_assert(offsetof(UBasicReplicationGraph, GridNode) == 0x000618, "Member 'UBasicReplicationGraph::GridNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantNode) == 0x000620, "Member 'UBasicReplicationGraph::AlwaysRelevantNode' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, AlwaysRelevantForConnectionList) == 0x000628, "Member 'UBasicReplicationGraph::AlwaysRelevantForConnectionList' has a wrong offset!");
static_assert(offsetof(UBasicReplicationGraph, ActorsWithoutNetConnection) == 0x000638, "Member 'UBasicReplicationGraph::ActorsWithoutNetConnection' has a wrong offset!");
...
public:
	...
	class UReplicationGraphNode_ActorListFrequencyBuckets* LowFrequencyNode;                         // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UReplicationGraphNode_GridCell) == 0x000130, "Wrong size on UReplicationGraphNode_GridCell");
...
static_assert(offsetof(UReplicationGraphNode_GridCell, LowFrequencyNode) == 0x000120, "Member 'UReplicationGraphNode_GridCell::LowFrequencyNode' has a wrong offset!");

// Class ReplicationGraph.ReplicationGraphNode_GridSpatialization2D
// 0x0288 (0x02D8 - 0x0050)
#pragma pack(push, 0x1)
class alignas(0x08) UReplicationGraphNode_GridSpatialization2D : public UReplicationGraphNode
{
public:
	uint8                                         Pad_50[0x288];                                     // 0x0050(0x0288)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UReplicationGraphNode_GridSpatialization2D) == 0x0002D8, "Wrong size on UReplicationGraphNode_GridSpatialization2D");
...
public:
	...
	TArray<class UReplicationGraphNode*>          ConnectionGraphNodes;                              // 0x02E0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UReplicationGraphNode*                  PrepareNode;                                       // 0x02F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                  // 0x02F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_300[0xD0];                                     // 0x0300(0x00D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNetReplicationGraphConnection) == 0x0003D0, "Wrong size on UNetReplicationGraphConnection");
...
static_assert(offsetof(UNetReplicationGraphConnection, DebugActor) == 0x000260, "Member 'UNetReplicationGraphConnection::DebugActor' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, LastGatherLocations) == 0x000278, "Member 'UNetReplicationGraphConnection::LastGatherLocations' has a wrong offset!");
...
static_assert(offsetof(UNetReplicationGraphConnection, PrepareNode) == 0x0002F0, "Member 'UNetReplicationGraphConnection::PrepareNode' has a wrong offset!");
static_assert(offsetof(UNetReplicationGraphConnection, TearOffNode) == 0x0002F8, "Member 'UNetReplicationGraphConnection::TearOffNode' has a wrong offset!");
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x02D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x02E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x0002E8, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x0002D8, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x0002E0, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
