...
struct CommonInputSubsystem_SetCanChangeInputMethod final
{
public:
	bool                                          bCanChange;                                        // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(CommonInputSubsystem_SetCanChangeInputMethod) == 0x000001, "Wrong alignment on CommonInputSubsystem_SetCanChangeInputMethod");
static_assert(sizeof(CommonInputSubsystem_SetCanChangeInputMethod) == 0x000001, "Wrong size on CommonInputSubsystem_SetCanChangeInputMethod");
static_assert(offsetof(CommonInputSubsystem_SetCanChangeInputMethod, bCanChange) == 0x000000, "Member 'CommonInputSubsystem_SetCanChangeInputMethod::bCanChange' has a wrong offset!");
...
static_assert(sizeof(CommonInputSubsystem_SetCurrentInputType) == 0x000002, "Wrong size on CommonInputSubsystem_SetCurrentInputType");
...
static_assert(offsetof(CommonInputSubsystem_SetCurrentInputType, ReturnValue) == 0x000001, "Member 'CommonInputSubsystem_SetCurrentInputType::ReturnValue' has a wrong offset!");
