...
float UDLSSLibrary::GetCurrentDesiredResolutionFraction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("DLSSLibrary", "GetCurrentDesiredResolutionFraction");

	Params::DLSSLibrary_GetCurrentDesiredResolutionFraction Parms{};
...
void UDLSSLibrary::SetCurrentDesiredResolutionFraction(float Fraction)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("DLSSLibrary", "SetCurrentDesiredResolutionFraction");

	Params::DLSSLibrary_SetCurrentDesiredResolutionFraction Parms{};
