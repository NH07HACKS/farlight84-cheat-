...
void UFoliageType::SetCullDistance(float MinCullDistance, float MaxCullDistance)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FoliageType", "SetCullDistance");

	Params::FoliageType_SetCullDistance Parms{};
