...
// NumValues: 0x0003
enum class ERepAnimPositionMethod : uint32
{
	Position                                 = 0,
	CurrentSectionId                         = 1,
...
// NumValues: 0x0003
enum class ETagRequirementCheckRule : uint8
{
	HasAll                                   = 0,
	HasAny                                   = 1,
...
public:
	...
	TArray<class AActor*>                         RelatedActorArray;                                 // 0x00B8(0x0010)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayCueParameters, RelatedActorArray) == 0x0000B8, "Member 'FGameplayCueParameters::RelatedActorArray' has a wrong offset!");
...
public:
	...
	struct FGameplayCueParameters                 Parameters;                                        // 0x0030(0x00D0)(ContainsInstancedReference, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FActiveGameplayEffect>          GameplayEffects_Internal;                          // 0x0140(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_150[0x310];                                    // 0x0150(0x0310)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayEffect*>                ApplicationImmunityQueryEffects;                   // 0x0460(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FActiveGameplayEffectsContainer) == 0x000488, "Wrong size on FActiveGameplayEffectsContainer");
...
static_assert(offsetof(FActiveGameplayEffectsContainer, ApplicationImmunityQueryEffects) == 0x000460, "Member 'FActiveGameplayEffectsContainer::ApplicationImmunityQueryEffects' has a wrong offset!");
...
{
public:
	uint8                                         AnimInstanceID;                                    // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          PlayBit;                                           // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPredictionKey                         PredictionKey;                                     // 0x0018(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UGameplayAbility*                       AnimatingAbility;                                  // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, AnimInstanceID) == 0x000000, "Member 'FGameplayAbilityLocalAnimMontage::AnimInstanceID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, AnimMontage) == 0x000008, "Member 'FGameplayAbilityLocalAnimMontage::AnimMontage' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, PlayBit) == 0x000010, "Member 'FGameplayAbilityLocalAnimMontage::PlayBit' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, PredictionKey) == 0x000018, "Member 'FGameplayAbilityLocalAnimMontage::PredictionKey' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityLocalAnimMontage, AnimatingAbility) == 0x000030, "Member 'FGameplayAbilityLocalAnimMontage::AnimatingAbility' has a wrong offset!");
...
public:
	...
	uint8                                         AnimInstanceID;                                    // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimMontage*                           AnimMontage;                                       // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PlayRate;                                          // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Position;                                          // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         BlendTime;                                         // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bRepPosition : 1;                                  // 0x0025(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         IsStopped : 1;                                     // 0x0025(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         ForcePlayBit : 1;                                  // 0x0025(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         SkipPositionCorrection : 1;                        // 0x0025(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bSkipPlayRate : 1;                                 // 0x0025(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bBlockNotifies : 1;                                // 0x0025(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bRootMotionDisabled : 1;                           // 0x0025(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_26[0x2];                                       // 0x0026(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPredictionKey                         PredictionKey;                                     // 0x0028(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         SectionIdToPlay;                                   // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FGameplayAbilityRepAnimMontage) == 0x000048, "Wrong size on FGameplayAbilityRepAnimMontage");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, AnimInstanceID) == 0x00000C, "Member 'FGameplayAbilityRepAnimMontage::AnimInstanceID' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, AnimMontage) == 0x000010, "Member 'FGameplayAbilityRepAnimMontage::AnimMontage' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PlayRate) == 0x000018, "Member 'FGameplayAbilityRepAnimMontage::PlayRate' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, Position) == 0x00001C, "Member 'FGameplayAbilityRepAnimMontage::Position' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, BlendTime) == 0x000020, "Member 'FGameplayAbilityRepAnimMontage::BlendTime' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontage, NextSectionID) == 0x000024, "Member 'FGameplayAbilityRepAnimMontage::NextSectionID' has a wrong offset!");
...
static_assert(offsetof(FGameplayAbilityRepAnimMontage, SectionIdToPlay) == 0x000040, "Member 'FGameplayAbilityRepAnimMontage::SectionIdToPlay' has a wrong offset!");

// ScriptStruct GameplayAbilities.GameplayAbilityRepAnimMontageContainer
// 0x0018 (0x0120 - 0x0108)
struct FGameplayAbilityRepAnimMontageContainer final : public FFastArraySerializer
{
public:
	TArray<struct FGameplayAbilityRepAnimMontage> AbilityMontages;                                   // 0x0108(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FGameplayAbilityRepAnimMontageContainer) == 0x000008, "Wrong alignment on FGameplayAbilityRepAnimMontageContainer");
static_assert(sizeof(FGameplayAbilityRepAnimMontageContainer) == 0x000120, "Wrong size on FGameplayAbilityRepAnimMontageContainer");
static_assert(offsetof(FGameplayAbilityRepAnimMontageContainer, AbilityMontages) == 0x000108, "Member 'FGameplayAbilityRepAnimMontageContainer::AbilityMontages' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityRepAnimMontageContainer, Owner) == 0x000118, "Member 'FGameplayAbilityRepAnimMontageContainer::Owner' has a wrong offset!");
...
public:
	...
	int32                                         ClientCachedLevel;                                 // 0x00C8(0x0004)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_CC[0x4];                                       // 0x00CC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayAbilitySpec) == 0x000008, "Wrong alignment on FGameplayAbilitySpec");
static_assert(sizeof(FGameplayAbilitySpec) == 0x0000D0, "Wrong size on FGameplayAbilitySpec");
...
static_assert(offsetof(FGameplayAbilitySpec, ClientCachedLevel) == 0x0000C8, "Member 'FGameplayAbilitySpec::ClientCachedLevel' has a wrong offset!");
...
{
public:
	ETagRequirementCheckRule                      RequireTagCheckRule;                               // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x7];                                        // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  RequireTags;                                       // 0x0008(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	ETagRequirementCheckRule                      IgnoreTagCheckRule;                                // 0x0028(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  IgnoreTags;                                        // 0x0030(0x0020)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayTagRequirements) == 0x000008, "Wrong alignment on FGameplayTagRequirements");
static_assert(sizeof(FGameplayTagRequirements) == 0x000050, "Wrong size on FGameplayTagRequirements");
static_assert(offsetof(FGameplayTagRequirements, RequireTagCheckRule) == 0x000000, "Member 'FGameplayTagRequirements::RequireTagCheckRule' has a wrong offset!");
static_assert(offsetof(FGameplayTagRequirements, RequireTags) == 0x000008, "Member 'FGameplayTagRequirements::RequireTags' has a wrong offset!");
static_assert(offsetof(FGameplayTagRequirements, IgnoreTagCheckRule) == 0x000028, "Member 'FGameplayTagRequirements::IgnoreTagCheckRule' has a wrong offset!");
static_assert(offsetof(FGameplayTagRequirements, IgnoreTags) == 0x000030, "Member 'FGameplayTagRequirements::IgnoreTags' has a wrong offset!");
...
public:
	...
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0210(0x0050)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0260(0x0050)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FGameplayModifierInfo) == 0x000008, "Wrong alignment on FGameplayModifierInfo");
static_assert(sizeof(FGameplayModifierInfo) == 0x0002B0, "Wrong size on FGameplayModifierInfo");
...
public:
	...
	struct FGameplayTagRequirements               SourceTags;                                        // 0x0200(0x0050)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagRequirements               TargetTags;                                        // 0x0250(0x0050)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FGameplayEffectExecutionScopedModifierInfo) == 0x0002A0, "Wrong size on FGameplayEffectExecutionScopedModifierInfo");
...
static_assert(offsetof(FGameplayEffectExecutionScopedModifierInfo, TargetTags) == 0x000250, "Member 'FGameplayEffectExecutionScopedModifierInfo::TargetTags' has a wrong offset!");
