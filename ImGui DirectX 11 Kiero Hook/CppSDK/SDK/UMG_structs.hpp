...
// Enum UMG.EWidgetStickyFlag
// NumValues: 0x0004
enum class EWidgetStickyFlag : uint8
{
	None                                     = 0,
	ForceSlowDown                            = 1,
	IgnoreSlowDown                           = 2,
...
// Enum UMG.EWidgetPlatformType
// NumValues: 0x0004
enum class EWidgetPlatformType : uint8
{
	DesktopAndMobile                         = 0,
	OnlyDesktop                              = 1,
	OnlyMobile                               = 2,
...
public:
	...
	bool                                          bLockRatio;                                        // 0x0020(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Alignment;                                         // 0x0024(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAnchorData) == 0x000004, "Wrong alignment on FAnchorData");
static_assert(sizeof(FAnchorData) == 0x00002C, "Wrong size on FAnchorData");
...
static_assert(offsetof(FAnchorData, bLockRatio) == 0x000020, "Member 'FAnchorData::bLockRatio' has a wrong offset!");
static_assert(offsetof(FAnchorData, Alignment) == 0x000024, "Member 'FAnchorData::Alignment' has a wrong offset!");

// ScriptStruct UMG.WidgetAnimationToTimelinePair
// 0x0018 (0x0018 - 0x0000)
struct FWidgetAnimationToTimelinePair final
{
public:
	class FString                                 AnimationLabel;                                    // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                TimelineObject;                                    // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetAnimationToTimelinePair) == 0x000008, "Wrong alignment on FWidgetAnimationToTimelinePair");
static_assert(sizeof(FWidgetAnimationToTimelinePair) == 0x000018, "Wrong size on FWidgetAnimationToTimelinePair");
static_assert(offsetof(FWidgetAnimationToTimelinePair, AnimationLabel) == 0x000000, "Member 'FWidgetAnimationToTimelinePair::AnimationLabel' has a wrong offset!");
static_assert(offsetof(FWidgetAnimationToTimelinePair, TimelineObject) == 0x000010, "Member 'FWidgetAnimationToTimelinePair::TimelineObject' has a wrong offset!");
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0010(0x0540)(Edit, NativeAccessSpecifierPublic)
	int32                                         FontSizeDesktop;                                   // 0x0550(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_554[0x55C];                                    // 0x0554(0x055C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRichTextStyleRow) == 0x000010, "Wrong alignment on FRichTextStyleRow");
static_assert(sizeof(FRichTextStyleRow) == 0x000AB0, "Wrong size on FRichTextStyleRow");
static_assert(offsetof(FRichTextStyleRow, TextStyle) == 0x000010, "Member 'FRichTextStyleRow::TextStyle' has a wrong offset!");
static_assert(offsetof(FRichTextStyleRow, FontSizeDesktop) == 0x000550, "Member 'FRichTextStyleRow::FontSizeDesktop' has a wrong offset!");

// ScriptStruct UMG.SlateFontInfoOverride
// 0x0008 (0x0008 - 0x0000)
struct FSlateFontInfoOverride final
{
public:
	int32                                         SizeMobile;                                        // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SizeDesktop;                                       // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSlateFontInfoOverride) == 0x000004, "Wrong alignment on FSlateFontInfoOverride");
static_assert(sizeof(FSlateFontInfoOverride) == 0x000008, "Wrong size on FSlateFontInfoOverride");
static_assert(offsetof(FSlateFontInfoOverride, SizeMobile) == 0x000000, "Member 'FSlateFontInfoOverride::SizeMobile' has a wrong offset!");
static_assert(offsetof(FSlateFontInfoOverride, SizeDesktop) == 0x000004, "Member 'FSlateFontInfoOverride::SizeDesktop' has a wrong offset!");

// ScriptStruct UMG.RichInlineTextRow
// 0x0578 (0x0580 - 0x0008)
struct FRichInlineTextRow final : public FTableRowBase
{
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTextBlockStyle                        TextBlockStyle;                                    // 0x0010(0x0540)(Edit, NativeAccessSpecifierPublic)
	struct FMargin                                Margin;                                            // 0x0550(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	float                                         LineHeightPercentage;                              // 0x0560(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWidgetTransform                       Transform;                                         // 0x0564(0x001C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRichInlineTextRow) == 0x000010, "Wrong alignment on FRichInlineTextRow");
static_assert(sizeof(FRichInlineTextRow) == 0x000580, "Wrong size on FRichInlineTextRow");
static_assert(offsetof(FRichInlineTextRow, TextBlockStyle) == 0x000010, "Member 'FRichInlineTextRow::TextBlockStyle' has a wrong offset!");
static_assert(offsetof(FRichInlineTextRow, Margin) == 0x000550, "Member 'FRichInlineTextRow::Margin' has a wrong offset!");
static_assert(offsetof(FRichInlineTextRow, LineHeightPercentage) == 0x000560, "Member 'FRichInlineTextRow::LineHeightPercentage' has a wrong offset!");
static_assert(offsetof(FRichInlineTextRow, Transform) == 0x000564, "Member 'FRichInlineTextRow::Transform' has a wrong offset!");

// ScriptStruct UMG.RichImageAttributes
// 0x0020 (0x0020 - 0x0000)
struct alignas(0x04) FRichImageAttributes final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRichImageAttributes) == 0x000004, "Wrong alignment on FRichImageAttributes");
static_assert(sizeof(FRichImageAttributes) == 0x000020, "Wrong size on FRichImageAttributes");
...
{
public:
	struct FSoftObjectPath                        WeakResourceObject;                                // 0x0008(0x0018)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            Brush;                                             // 0x0020(0x0110)(Edit, NativeAccessSpecifierPublic)
	struct FVector2D                              ImageSizeDesktop;                                  // 0x0130(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_138[0x128];                                    // 0x0138(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	EHorizontalAlignment                          HAlign;                                            // 0x0260(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_261[0x3];                                      // 0x0261(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Offset;                                            // 0x0264(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FRichImageRow) == 0x000270, "Wrong size on FRichImageRow");
static_assert(offsetof(FRichImageRow, WeakResourceObject) == 0x000008, "Member 'FRichImageRow::WeakResourceObject' has a wrong offset!");
static_assert(offsetof(FRichImageRow, Brush) == 0x000020, "Member 'FRichImageRow::Brush' has a wrong offset!");
static_assert(offsetof(FRichImageRow, ImageSizeDesktop) == 0x000130, "Member 'FRichImageRow::ImageSizeDesktop' has a wrong offset!");
static_assert(offsetof(FRichImageRow, HAlign) == 0x000260, "Member 'FRichImageRow::HAlign' has a wrong offset!");
static_assert(offsetof(FRichImageRow, Offset) == 0x000264, "Member 'FRichImageRow::Offset' has a wrong offset!");
