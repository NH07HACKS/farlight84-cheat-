...
// Enum AkAudio.EGameplayVoiceType
// NumValues: 0x0004
...
// Enum AkAudio.EPooledEmitterStatus
// NumValues: 0x0006
enum class EPooledEmitterStatus : uint8
{
	Registered                               = 0,
	Playing                                  = 1,
	Stopped                                  = 2,
...
// Enum AkAudio.EVoicePriorityGroupType
// NumValues: 0x0004
enum class EVoicePriorityGroupType : uint8
{
	Invalid                                  = 0,
	Character                                = 1,
	BattleBroadcast                          = 2,
...
// Enum AkAudio.EEventPriorityStatus
// NumValues: 0x0006
enum class EEventPriorityStatus : uint8
{
	Available                                = 0,
	Waiting                                  = 1,
...
// ScriptStruct AkAudio.EventWithPriorityCallbackData
// 0x0050 (0x0050 - 0x0000)
struct FEventWithPriorityCallbackData final
{
public:
	uint16                                        VoiceType;                                         // 0x0000(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        VoiceTypeSecond;                                   // 0x0002(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        SpecialBehaviorUID;                                // 0x0004(0x0002)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6[0x2];                                        // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 NickName;                                          // 0x0008(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LocalizationID;                                    // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LocalizationIDSecond;                              // 0x001C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 EventNameSecond;                                   // 0x0020(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PosInTeam;                                         // 0x0030(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsLocalPlayer;                                    // 0x0034(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayVoiceType                            GameplayVoiceType;                                 // 0x0035(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_36[0x2];                                       // 0x0036(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 InteractionUniqueID;                               // 0x0038(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         IgnoreTeammatePos;                                 // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEventWithPriorityCallbackData) == 0x000008, "Wrong alignment on FEventWithPriorityCallbackData");
static_assert(sizeof(FEventWithPriorityCallbackData) == 0x000050, "Wrong size on FEventWithPriorityCallbackData");
static_assert(offsetof(FEventWithPriorityCallbackData, VoiceType) == 0x000000, "Member 'FEventWithPriorityCallbackData::VoiceType' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, VoiceTypeSecond) == 0x000002, "Member 'FEventWithPriorityCallbackData::VoiceTypeSecond' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, SpecialBehaviorUID) == 0x000004, "Member 'FEventWithPriorityCallbackData::SpecialBehaviorUID' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, NickName) == 0x000008, "Member 'FEventWithPriorityCallbackData::NickName' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, LocalizationID) == 0x000018, "Member 'FEventWithPriorityCallbackData::LocalizationID' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, LocalizationIDSecond) == 0x00001C, "Member 'FEventWithPriorityCallbackData::LocalizationIDSecond' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, EventNameSecond) == 0x000020, "Member 'FEventWithPriorityCallbackData::EventNameSecond' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, PosInTeam) == 0x000030, "Member 'FEventWithPriorityCallbackData::PosInTeam' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, bIsLocalPlayer) == 0x000034, "Member 'FEventWithPriorityCallbackData::bIsLocalPlayer' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, GameplayVoiceType) == 0x000035, "Member 'FEventWithPriorityCallbackData::GameplayVoiceType' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, InteractionUniqueID) == 0x000038, "Member 'FEventWithPriorityCallbackData::InteractionUniqueID' has a wrong offset!");
static_assert(offsetof(FEventWithPriorityCallbackData, IgnoreTeammatePos) == 0x000048, "Member 'FEventWithPriorityCallbackData::IgnoreTeammatePos' has a wrong offset!");
...
// ScriptStruct AkAudio.AkAudioParamsRTPC
// 0x0018 (0x0018 - 0x0000)
struct FAkAudioParamsRTPC final
{
public:
...
static_assert(alignof(FAkAudioParamsRTPC) == 0x000008, "Wrong alignment on FAkAudioParamsRTPC");
static_assert(sizeof(FAkAudioParamsRTPC) == 0x000018, "Wrong size on FAkAudioParamsRTPC");
static_assert(offsetof(FAkAudioParamsRTPC, Name) == 0x000000, "Member 'FAkAudioParamsRTPC::Name' has a wrong offset!");
static_assert(offsetof(FAkAudioParamsRTPC, Value) == 0x000010, "Member 'FAkAudioParamsRTPC::Value' has a wrong offset!");
...
// ScriptStruct AkAudio.AkAudioParamsSwitch
// 0x0020 (0x0020 - 0x0000)
struct FAkAudioParamsSwitch final
{
public:
...
static_assert(alignof(FAkAudioParamsSwitch) == 0x000008, "Wrong alignment on FAkAudioParamsSwitch");
static_assert(sizeof(FAkAudioParamsSwitch) == 0x000020, "Wrong size on FAkAudioParamsSwitch");
static_assert(offsetof(FAkAudioParamsSwitch, GroupName) == 0x000000, "Member 'FAkAudioParamsSwitch::GroupName' has a wrong offset!");
static_assert(offsetof(FAkAudioParamsSwitch, Name) == 0x000010, "Member 'FAkAudioParamsSwitch::Name' has a wrong offset!");
...
// 0x0050 (0x0050 - 0x0000)
struct FEventCooldownData final
{
public:
	TMap<class FString, float>                    Data;                                              // 0x0000(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FEventCooldownData) == 0x000008, "Wrong alignment on FEventCooldownData");
static_assert(sizeof(FEventCooldownData) == 0x000050, "Wrong size on FEventCooldownData");
static_assert(offsetof(FEventCooldownData, Data) == 0x000000, "Member 'FEventCooldownData::Data' has a wrong offset!");

// ScriptStruct AkAudio.CachedGameSyncData
// 0x00A0 (0x00A0 - 0x0000)
struct FCachedGameSyncData final
{
public:
	TMap<class FString, float>                    RTPCData;                                          // 0x0000(0x0050)(NativeAccessSpecifierPublic)
	TMap<class FString, class FString>            SwitchData;                                        // 0x0050(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FCachedGameSyncData) == 0x000008, "Wrong alignment on FCachedGameSyncData");
static_assert(sizeof(FCachedGameSyncData) == 0x0000A0, "Wrong size on FCachedGameSyncData");
static_assert(offsetof(FCachedGameSyncData, RTPCData) == 0x000000, "Member 'FCachedGameSyncData::RTPCData' has a wrong offset!");
static_assert(offsetof(FCachedGameSyncData, SwitchData) == 0x000050, "Member 'FCachedGameSyncData::SwitchData' has a wrong offset!");
...
struct FWwiseDataRow final : public FTableRowBase
{
public:
	class FName                                   SoundbankName;                                     // 0x0008(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bHasEventLowMemory;                                // 0x0018(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWwiseDataRow) == 0x000008, "Wrong alignment on FWwiseDataRow");
static_assert(sizeof(FWwiseDataRow) == 0x000020, "Wrong size on FWwiseDataRow");
static_assert(offsetof(FWwiseDataRow, SoundbankName) == 0x000008, "Member 'FWwiseDataRow::SoundbankName' has a wrong offset!");
static_assert(offsetof(FWwiseDataRow, EventName) == 0x000010, "Member 'FWwiseDataRow::EventName' has a wrong offset!");
static_assert(offsetof(FWwiseDataRow, bHasEventLowMemory) == 0x000018, "Member 'FWwiseDataRow::bHasEventLowMemory' has a wrong offset!");
