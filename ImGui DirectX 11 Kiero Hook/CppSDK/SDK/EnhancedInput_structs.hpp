...
public:
	...
	uint8                                         bShouldBeIgnored : 1;                              // 0x0020(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FEnhancedActionKeyMapping) == 0x000048, "Wrong size on FEnhancedActionKeyMapping");
...
static_assert(offsetof(FEnhancedActionKeyMapping, Triggers) == 0x000028, "Member 'FEnhancedActionKeyMapping::Triggers' has a wrong offset!");
static_assert(offsetof(FEnhancedActionKeyMapping, Modifiers) == 0x000038, "Member 'FEnhancedActionKeyMapping::Modifiers' has a wrong offset!");
...
public:
	...
	struct FKey                                   FromKey;                                           // 0x0008(0x0018)(Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_20[0x8];                                       // 0x0020(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UInputTrigger*>                  Triggers;                                          // 0x0028(0x0010)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UInputModifier*>                 Modifiers;                                         // 0x0038(0x0010)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, ContainsInstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UInputModifier*>                 PerInputModifiers;                                 // 0x0048(0x0010)(ZeroConstructor, Deprecated, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UInputModifier*>                 FinalValueModifiers;                               // 0x0058(0x0010)(ZeroConstructor, Deprecated, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	ETriggerEvent                                 TriggerEvent;                                      // 0x0080(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(FInputActionInstance, FromKey) == 0x000008, "Member 'FInputActionInstance::FromKey' has a wrong offset!");
static_assert(offsetof(FInputActionInstance, Triggers) == 0x000028, "Member 'FInputActionInstance::Triggers' has a wrong offset!");
static_assert(offsetof(FInputActionInstance, Modifiers) == 0x000038, "Member 'FInputActionInstance::Modifiers' has a wrong offset!");
static_assert(offsetof(FInputActionInstance, PerInputModifiers) == 0x000048, "Member 'FInputActionInstance::PerInputModifiers' has a wrong offset!");
static_assert(offsetof(FInputActionInstance, FinalValueModifiers) == 0x000058, "Member 'FInputActionInstance::FinalValueModifiers' has a wrong offset!");
...
static_assert(offsetof(FInputActionInstance, TriggerEvent) == 0x000080, "Member 'FInputActionInstance::TriggerEvent' has a wrong offset!");
