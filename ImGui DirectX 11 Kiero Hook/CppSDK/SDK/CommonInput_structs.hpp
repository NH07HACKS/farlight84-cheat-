...
// 0x0018 (0x0018 - 0x0000)
struct FCommonInputControllerSimpleData final
{
public:
...
static_assert(alignof(FCommonInputControllerSimpleData) == 0x000008, "Wrong alignment on FCommonInputControllerSimpleData");
static_assert(sizeof(FCommonInputControllerSimpleData) == 0x000018, "Wrong size on FCommonInputControllerSimpleData");
static_assert(offsetof(FCommonInputControllerSimpleData, GamepadName) == 0x000000, "Member 'FCommonInputControllerSimpleData::GamepadName' has a wrong offset!");
static_assert(offsetof(FCommonInputControllerSimpleData, GamepadHardwareIdMapping) == 0x000008, "Member 'FCommonInputControllerSimpleData::GamepadHardwareIdMapping' has a wrong offset!");
...
public:
	...
	TArray<TSoftClassPtr<class UClass>>           ControllerData;                                    // 0x0018(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<TSubclassOf<class UCommonInputBaseControllerData>> ControllerDataClasses;                 // 0x0028(0x0010)(ZeroConstructor, Transient, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FCommonInputPlatformBaseData) == 0x000048, "Wrong size on FCommonInputPlatformBaseData");
...
static_assert(offsetof(FCommonInputPlatformBaseData, ControllerSimpleData) == 0x000038, "Member 'FCommonInputPlatformBaseData::ControllerSimpleData' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            KeyBrush;                                          // 0x0010(0x0110)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FCommonInputKeySetBrushConfiguration) == 0x000120, "Wrong size on FCommonInputKeySetBrushConfiguration");
...
public:
	...
	struct FSlateBrush                            KeyBrush;                                          // 0x0020(0x0110)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCommonInputKeyBrushConfiguration) == 0x000010, "Wrong alignment on FCommonInputKeyBrushConfiguration");
static_assert(sizeof(FCommonInputKeyBrushConfiguration) == 0x000130, "Wrong size on FCommonInputKeyBrushConfiguration");
