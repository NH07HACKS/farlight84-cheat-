...
public:
	...
	uint32                                        ReplayNetworkGUID;                                 // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FLevelSequenceBindingReference, ReplayNetworkGUID) == 0x000038, "Member 'FLevelSequenceBindingReference::ReplayNetworkGUID' has a wrong offset!");
