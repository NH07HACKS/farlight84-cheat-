...
public:
	...
	TWeakObjectPtr<class ACharacter>              CharacterOwner;                                    // 0x00D8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class URootMotionModifier*>            Modifiers;                                         // 0x00E0(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FMotionWarpingTarget>           WarpTargets;                                       // 0x00F0(0x0010)(Net, ZeroConstructor, Transient, ContainsInstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMotionWarpingComponent) == 0x000130, "Wrong size on UMotionWarpingComponent");
...
static_assert(offsetof(UMotionWarpingComponent, CharacterOwner) == 0x0000D8, "Member 'UMotionWarpingComponent::CharacterOwner' has a wrong offset!");
...
public:
	...
	EAlphaBlendOption                             AddTranslationEasingFunc;                          // 0x010B(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10C[0x4];                                      // 0x010C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            AddTranslationEasingCurve;                         // 0x0110(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URootMotionModifier_Warp) == 0x0001B0, "Wrong size on URootMotionModifier_Warp");
...
static_assert(offsetof(URootMotionModifier_Warp, bOnlyZAxis) == 0x00010A, "Member 'URootMotionModifier_Warp::bOnlyZAxis' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, AddTranslationEasingFunc) == 0x00010B, "Member 'URootMotionModifier_Warp::AddTranslationEasingFunc' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SimpleWarp) == 0x0001B0, "Wrong size on URootMotionModifier_SimpleWarp");
...
// Class MotionWarping.RootMotionModifier_ApplyInput
// 0x0000 (0x00C0 - 0x00C0)
class URootMotionModifier_ApplyInput final : public URootMotionModifier
{
public:
	...
	bool                                          bOverrideWithInput;                                // 0x00BC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_BD[0x3];                                       // 0x00BD(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"RootMotionModifier_ApplyInput">();
	}
	static class URootMotionModifier_ApplyInput* GetDefaultObj()
	{
		return GetDefaultObjImpl<URootMotionModifier_ApplyInput>();
	}
};
static_assert(alignof(URootMotionModifier_ApplyInput) == 0x000010, "Wrong alignment on URootMotionModifier_ApplyInput");
static_assert(sizeof(URootMotionModifier_ApplyInput) == 0x0000C0, "Wrong size on URootMotionModifier_ApplyInput");
static_assert(offsetof(URootMotionModifier_ApplyInput, Scale) == 0x0000B8, "Member 'URootMotionModifier_ApplyInput::Scale' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_ApplyInput, bOverrideWithInput) == 0x0000BC, "Member 'URootMotionModifier_ApplyInput::bOverrideWithInput' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_AdjustmentBlendWarp) == 0x000280, "Wrong size on URootMotionModifier_AdjustmentBlendWarp");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, bWarpIKBones) == 0x0001B0, "Member 'URootMotionModifier_AdjustmentBlendWarp::bWarpIKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, IKBones) == 0x0001B8, "Member 'URootMotionModifier_AdjustmentBlendWarp::IKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshTransform) == 0x0001D0, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshRelativeTransform) == 0x000200, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshRelativeTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedRootMotion) == 0x000230, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedRootMotion' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, Result) == 0x000260, "Member 'URootMotionModifier_AdjustmentBlendWarp::Result' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1B0[0x1C];                                     // 0x01B0(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxWarpDistance;                                   // 0x01CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxWarpAngle;                                      // 0x01D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClampByWarpDir2D;                                 // 0x01D4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URootMotionModifier_SkewWarp) == 0x0001E0, "Wrong size on URootMotionModifier_SkewWarp");
static_assert(offsetof(URootMotionModifier_SkewWarp, MaxWarpDistance) == 0x0001CC, "Member 'URootMotionModifier_SkewWarp::MaxWarpDistance' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_SkewWarp, MaxWarpAngle) == 0x0001D0, "Member 'URootMotionModifier_SkewWarp::MaxWarpAngle' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_SkewWarp, bClampByWarpDir2D) == 0x0001D4, "Member 'URootMotionModifier_SkewWarp::bClampByWarpDir2D' has a wrong offset!");
