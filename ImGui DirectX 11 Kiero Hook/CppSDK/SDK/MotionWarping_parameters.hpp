...
static_assert(sizeof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp) == 0x000090, "Wrong size on RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp");
...
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, InWarpPointAnimBoneName) == 0x000060, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::InWarpPointAnimBoneName' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInWarpTranslation) == 0x000068, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInWarpTranslation' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInIgnoreZAxis) == 0x000069, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInIgnoreZAxis' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInWarpRotation) == 0x00006A, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInWarpRotation' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, bInWarpIKBones) == 0x00006B, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::bInWarpIKBones' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, InIKBones) == 0x000070, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::InIKBones' has a wrong offset!");
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp, ReturnValue) == 0x000080, "Member 'RootMotionModifier_AdjustmentBlendWarp_AddRootMotionModifierAdjustmentBlendWarp::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(RootMotionModifier_AdjustmentBlendWarp_GetAdjustmentBlendIKBoneTransformAndAlpha) == 0x000050, "Wrong size on RootMotionModifier_AdjustmentBlendWarp_GetAdjustmentBlendIKBoneTransformAndAlpha");
...
static_assert(offsetof(RootMotionModifier_AdjustmentBlendWarp_GetAdjustmentBlendIKBoneTransformAndAlpha, OutAlpha) == 0x000040, "Member 'RootMotionModifier_AdjustmentBlendWarp_GetAdjustmentBlendIKBoneTransformAndAlpha::OutAlpha' has a wrong offset!");
