...
struct FRawInputDeadzoneConfiguration final
{
public:
...
static_assert(alignof(FRawInputDeadzoneConfiguration) == 0x000008, "Wrong alignment on FRawInputDeadzoneConfiguration");
static_assert(sizeof(FRawInputDeadzoneConfiguration) == 0x000018, "Wrong size on FRawInputDeadzoneConfiguration");
static_assert(offsetof(FRawInputDeadzoneConfiguration, Deadzone) == 0x000000, "Member 'FRawInputDeadzoneConfiguration::Deadzone' has a wrong offset!");
static_assert(offsetof(FRawInputDeadzoneConfiguration, Keys) == 0x000008, "Member 'FRawInputDeadzoneConfiguration::Keys' has a wrong offset!");
