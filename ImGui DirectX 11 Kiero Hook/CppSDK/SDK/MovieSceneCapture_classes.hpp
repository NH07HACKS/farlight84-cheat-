...
// Class MovieSceneCapture.MovieSceneBlueprintLibrary
// 0x0000 (0x0028 - 0x0028)
class UMovieSceneBlueprintLibrary final : public UBlueprintFunctionLibrary
{
public:
	static bool Initialize(const class FString& OutputFile, int32 FrameRate, int32 CompressQuality);
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneBlueprintLibrary">();
	}
	static class UMovieSceneBlueprintLibrary* GetDefaultObj()
	{
		return GetDefaultObjImpl<UMovieSceneBlueprintLibrary>();
	}
};
static_assert(alignof(UMovieSceneBlueprintLibrary) == 0x000008, "Wrong alignment on UMovieSceneBlueprintLibrary");
static_assert(sizeof(UMovieSceneBlueprintLibrary) == 0x000028, "Wrong size on UMovieSceneBlueprintLibrary");
