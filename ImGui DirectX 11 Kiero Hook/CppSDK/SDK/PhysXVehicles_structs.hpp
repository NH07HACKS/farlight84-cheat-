...
static_assert(sizeof(FAnimNode_WheelHandler) == 0x0000E8, "Wrong size on FAnimNode_WheelHandler");
...
static_assert(sizeof(FVehicleAnimInstanceProxy) == 0x000700, "Wrong size on FVehicleAnimInstanceProxy");
