...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09DD9188;
	constexpr int32 AppendString      = 0x04B76700;
	constexpr int32 GNames            = 0x09DC0780;
	constexpr int32 GWorld            = 0x09F37F70;
	constexpr int32 ProcessEvent      = 0x04C83230;
