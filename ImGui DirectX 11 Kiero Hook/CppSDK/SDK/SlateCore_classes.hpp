...
// Class SlateCore.StaticFontCacheObject
// 0x0010 (0x0038 - 0x0028)
class UStaticFontCacheObject final : public UObject
{
public:
	TArray<struct FStaticFontCacheInfo>           StaticFontCache;                                   // 0x0028(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"StaticFontCacheObject">();
	}
	static class UStaticFontCacheObject* GetDefaultObj()
	{
		return GetDefaultObjImpl<UStaticFontCacheObject>();
	}
};
static_assert(alignof(UStaticFontCacheObject) == 0x000008, "Wrong alignment on UStaticFontCacheObject");
static_assert(sizeof(UStaticFontCacheObject) == 0x000038, "Wrong size on UStaticFontCacheObject");
static_assert(offsetof(UStaticFontCacheObject, StaticFontCache) == 0x000028, "Member 'UStaticFontCacheObject::StaticFontCache' has a wrong offset!");
