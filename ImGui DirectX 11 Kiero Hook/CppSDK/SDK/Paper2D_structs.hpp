...
// ScriptStruct Paper2D.AssetMoveSerializeInfo
// 0x0030 (0x0030 - 0x0000)
struct FAssetMoveSerializeInfo final
{
public:
	class FString                                 OldAssetPath;                                      // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         RefWidgetBlueprintNames;                           // 0x0010(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NewAssetPath;                                      // 0x0020(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAssetMoveSerializeInfo) == 0x000008, "Wrong alignment on FAssetMoveSerializeInfo");
static_assert(sizeof(FAssetMoveSerializeInfo) == 0x000030, "Wrong size on FAssetMoveSerializeInfo");
static_assert(offsetof(FAssetMoveSerializeInfo, OldAssetPath) == 0x000000, "Member 'FAssetMoveSerializeInfo::OldAssetPath' has a wrong offset!");
static_assert(offsetof(FAssetMoveSerializeInfo, RefWidgetBlueprintNames) == 0x000010, "Member 'FAssetMoveSerializeInfo::RefWidgetBlueprintNames' has a wrong offset!");
static_assert(offsetof(FAssetMoveSerializeInfo, NewAssetPath) == 0x000020, "Member 'FAssetMoveSerializeInfo::NewAssetPath' has a wrong offset!");

// ScriptStruct Paper2D.TextureToAlwaysPackFromBlueprintEntry
// 0x0030 (0x0030 - 0x0000)
struct FTextureToAlwaysPackFromBlueprintEntry final
{
public:
	struct FSoftClassPath                         WidgetBlueprint;                                   // 0x0000(0x0018)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        SpriteAtlas;                                       // 0x0018(0x0018)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTextureToAlwaysPackFromBlueprintEntry) == 0x000008, "Wrong alignment on FTextureToAlwaysPackFromBlueprintEntry");
static_assert(sizeof(FTextureToAlwaysPackFromBlueprintEntry) == 0x000030, "Wrong size on FTextureToAlwaysPackFromBlueprintEntry");
static_assert(offsetof(FTextureToAlwaysPackFromBlueprintEntry, WidgetBlueprint) == 0x000000, "Member 'FTextureToAlwaysPackFromBlueprintEntry::WidgetBlueprint' has a wrong offset!");
static_assert(offsetof(FTextureToAlwaysPackFromBlueprintEntry, SpriteAtlas) == 0x000018, "Member 'FTextureToAlwaysPackFromBlueprintEntry::SpriteAtlas' has a wrong offset!");

// ScriptStruct Paper2D.TextureToAlwaysPackEntry
// 0x0040 (0x0040 - 0x0000)
struct FTextureToAlwaysPackEntry final
{
public:
	struct FSoftObjectPath                        Texture;                                           // 0x0000(0x0018)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        SpriteAtlas;                                       // 0x0018(0x0018)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSoftClassPath>                 WidgetBlueprints;                                  // 0x0030(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTextureToAlwaysPackEntry) == 0x000008, "Wrong alignment on FTextureToAlwaysPackEntry");
static_assert(sizeof(FTextureToAlwaysPackEntry) == 0x000040, "Wrong size on FTextureToAlwaysPackEntry");
static_assert(offsetof(FTextureToAlwaysPackEntry, Texture) == 0x000000, "Member 'FTextureToAlwaysPackEntry::Texture' has a wrong offset!");
static_assert(offsetof(FTextureToAlwaysPackEntry, SpriteAtlas) == 0x000018, "Member 'FTextureToAlwaysPackEntry::SpriteAtlas' has a wrong offset!");
static_assert(offsetof(FTextureToAlwaysPackEntry, WidgetBlueprints) == 0x000030, "Member 'FTextureToAlwaysPackEntry::WidgetBlueprints' has a wrong offset!");

// ScriptStruct Paper2D.UIBlueprintCommonMapPath
// 0x0020 (0x0020 - 0x0000)
struct FUIBlueprintCommonMapPath final
{
public:
	class FString                                 SrcPath;                                           // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 DstPath;                                           // 0x0010(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FUIBlueprintCommonMapPath) == 0x000008, "Wrong alignment on FUIBlueprintCommonMapPath");
static_assert(sizeof(FUIBlueprintCommonMapPath) == 0x000020, "Wrong size on FUIBlueprintCommonMapPath");
static_assert(offsetof(FUIBlueprintCommonMapPath, SrcPath) == 0x000000, "Member 'FUIBlueprintCommonMapPath::SrcPath' has a wrong offset!");
static_assert(offsetof(FUIBlueprintCommonMapPath, DstPath) == 0x000010, "Member 'FUIBlueprintCommonMapPath::DstPath' has a wrong offset!");
...
struct FPaperSpriteData final
{
public:
	struct FVector2D                              SourceUV;                                          // 0x0000(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              SourceDimension;                                   // 0x0008(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              BakedSourceUV;                                     // 0x0010(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              BakedSourceDimension;                              // 0x0018(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bBakedValid;                                       // 0x0020(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_21[0x3];                                       // 0x0021(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         AlternateMaterialSplitIndex;                       // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FVector4>                       BakedRenderData;                                   // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPaperSpriteData) == 0x000008, "Wrong alignment on FPaperSpriteData");
static_assert(sizeof(FPaperSpriteData) == 0x000038, "Wrong size on FPaperSpriteData");
static_assert(offsetof(FPaperSpriteData, SourceUV) == 0x000000, "Member 'FPaperSpriteData::SourceUV' has a wrong offset!");
static_assert(offsetof(FPaperSpriteData, SourceDimension) == 0x000008, "Member 'FPaperSpriteData::SourceDimension' has a wrong offset!");
static_assert(offsetof(FPaperSpriteData, BakedSourceUV) == 0x000010, "Member 'FPaperSpriteData::BakedSourceUV' has a wrong offset!");
static_assert(offsetof(FPaperSpriteData, BakedSourceDimension) == 0x000018, "Member 'FPaperSpriteData::BakedSourceDimension' has a wrong offset!");
static_assert(offsetof(FPaperSpriteData, bBakedValid) == 0x000020, "Member 'FPaperSpriteData::bBakedValid' has a wrong offset!");
static_assert(offsetof(FPaperSpriteData, AlternateMaterialSplitIndex) == 0x000024, "Member 'FPaperSpriteData::AlternateMaterialSplitIndex' has a wrong offset!");
static_assert(offsetof(FPaperSpriteData, BakedRenderData) == 0x000028, "Member 'FPaperSpriteData::BakedRenderData' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UPaperSpriteFrame>       SpriteRef;                                         // 0x0000(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// ScriptStruct Paper2D.WidgetBlueprintTextureToSpriteInfo
// 0x0010 (0x0010 - 0x0000)
struct FWidgetBlueprintTextureToSpriteInfo final
{
public:
	TArray<int32>                                 MoveInfoIndexList;                                 // 0x0000(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetBlueprintTextureToSpriteInfo) == 0x000008, "Wrong alignment on FWidgetBlueprintTextureToSpriteInfo");
static_assert(sizeof(FWidgetBlueprintTextureToSpriteInfo) == 0x000010, "Wrong size on FWidgetBlueprintTextureToSpriteInfo");
static_assert(offsetof(FWidgetBlueprintTextureToSpriteInfo, MoveInfoIndexList) == 0x000000, "Member 'FWidgetBlueprintTextureToSpriteInfo::MoveInfoIndexList' has a wrong offset!");

// ScriptStruct Paper2D.WidgetBlueprintTextureToSpriteEntry
// 0x0020 (0x0020 - 0x0000)
struct FWidgetBlueprintTextureToSpriteEntry final
{
public:
	class FString                                 OldAssetPath;                                      // 0x0000(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NewAssetPath;                                      // 0x0010(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetBlueprintTextureToSpriteEntry) == 0x000008, "Wrong alignment on FWidgetBlueprintTextureToSpriteEntry");
static_assert(sizeof(FWidgetBlueprintTextureToSpriteEntry) == 0x000020, "Wrong size on FWidgetBlueprintTextureToSpriteEntry");
static_assert(offsetof(FWidgetBlueprintTextureToSpriteEntry, OldAssetPath) == 0x000000, "Member 'FWidgetBlueprintTextureToSpriteEntry::OldAssetPath' has a wrong offset!");
static_assert(offsetof(FWidgetBlueprintTextureToSpriteEntry, NewAssetPath) == 0x000010, "Member 'FWidgetBlueprintTextureToSpriteEntry::NewAssetPath' has a wrong offset!");

// ScriptStruct Paper2D.PaperSpriteMoveInfo
// 0x0020 (0x0020 - 0x0000)
struct FPaperSpriteMoveInfo final
{
public:
	class FString                                 OldAssetPath;                                      // 0x0000(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 NewAssetPath;                                      // 0x0010(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPaperSpriteMoveInfo) == 0x000008, "Wrong alignment on FPaperSpriteMoveInfo");
static_assert(sizeof(FPaperSpriteMoveInfo) == 0x000020, "Wrong size on FPaperSpriteMoveInfo");
static_assert(offsetof(FPaperSpriteMoveInfo, OldAssetPath) == 0x000000, "Member 'FPaperSpriteMoveInfo::OldAssetPath' has a wrong offset!");
static_assert(offsetof(FPaperSpriteMoveInfo, NewAssetPath) == 0x000010, "Member 'FPaperSpriteMoveInfo::NewAssetPath' has a wrong offset!");
