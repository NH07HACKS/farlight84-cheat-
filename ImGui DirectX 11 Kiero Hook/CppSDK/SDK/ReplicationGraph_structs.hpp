...
struct FClassExtraReplicatedInfo final
{
public:
	TMap<class UClass*, int32>                    ClassActorsMaxReplicatedNum;                       // 0x0000(0x0050)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FClassExtraReplicatedInfo) == 0x000008, "Wrong alignment on FClassExtraReplicatedInfo");
static_assert(sizeof(FClassExtraReplicatedInfo) == 0x000050, "Wrong size on FClassExtraReplicatedInfo");
static_assert(offsetof(FClassExtraReplicatedInfo, ClassActorsMaxReplicatedNum) == 0x000000, "Member 'FClassExtraReplicatedInfo::ClassActorsMaxReplicatedNum' has a wrong offset!");
...
public:
	...
	float                                         CullDistanceRaw;                                   // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CullHeight;                                        // 0x0074(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CullHeightOnSkydiving;                             // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FClassReplicationInfo, CullDistanceRaw) == 0x000070, "Member 'FClassReplicationInfo::CullDistanceRaw' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, CullHeight) == 0x000074, "Member 'FClassReplicationInfo::CullHeight' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, CullHeightOnSkydiving) == 0x000078, "Member 'FClassReplicationInfo::CullHeightOnSkydiving' has a wrong offset!");
