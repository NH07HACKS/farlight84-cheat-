...
// Class EngineSettings.EditorSimulatePlatformSettings
// 0x0008 (0x0030 - 0x0028)
class UEditorSimulatePlatformSettings final : public UObject
{
public:
	bool                                          bSteamSession;                                     // 0x0028(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEpicSession;                                      // 0x0029(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOfficialWinSession;                               // 0x002A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOfficialWinPlatformLauncherSession;               // 0x002B(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWeGameSession;                                    // 0x002C(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSwitchSession;                                    // 0x002D(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E[0x2];                                       // 0x002E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"EditorSimulatePlatformSettings">();
	}
	static class UEditorSimulatePlatformSettings* GetDefaultObj()
	{
		return GetDefaultObjImpl<UEditorSimulatePlatformSettings>();
	}
};
static_assert(alignof(UEditorSimulatePlatformSettings) == 0x000008, "Wrong alignment on UEditorSimulatePlatformSettings");
static_assert(sizeof(UEditorSimulatePlatformSettings) == 0x000030, "Wrong size on UEditorSimulatePlatformSettings");
static_assert(offsetof(UEditorSimulatePlatformSettings, bSteamSession) == 0x000028, "Member 'UEditorSimulatePlatformSettings::bSteamSession' has a wrong offset!");
static_assert(offsetof(UEditorSimulatePlatformSettings, bEpicSession) == 0x000029, "Member 'UEditorSimulatePlatformSettings::bEpicSession' has a wrong offset!");
static_assert(offsetof(UEditorSimulatePlatformSettings, bOfficialWinSession) == 0x00002A, "Member 'UEditorSimulatePlatformSettings::bOfficialWinSession' has a wrong offset!");
static_assert(offsetof(UEditorSimulatePlatformSettings, bOfficialWinPlatformLauncherSession) == 0x00002B, "Member 'UEditorSimulatePlatformSettings::bOfficialWinPlatformLauncherSession' has a wrong offset!");
static_assert(offsetof(UEditorSimulatePlatformSettings, bWeGameSession) == 0x00002C, "Member 'UEditorSimulatePlatformSettings::bWeGameSession' has a wrong offset!");
static_assert(offsetof(UEditorSimulatePlatformSettings, bSwitchSession) == 0x00002D, "Member 'UEditorSimulatePlatformSettings::bSwitchSession' has a wrong offset!");
