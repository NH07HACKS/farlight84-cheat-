...
// Function Paper2D.AutoSpriteAtlasSettings.GetInstance
// 0x0008 (0x0008 - 0x0000)
struct AutoSpriteAtlasSettings_GetInstance final
{
public:
	class UAutoSpriteAtlasSettings*               ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(AutoSpriteAtlasSettings_GetInstance) == 0x000008, "Wrong alignment on AutoSpriteAtlasSettings_GetInstance");
static_assert(sizeof(AutoSpriteAtlasSettings_GetInstance) == 0x000008, "Wrong size on AutoSpriteAtlasSettings_GetInstance");
static_assert(offsetof(AutoSpriteAtlasSettings_GetInstance, ReturnValue) == 0x000000, "Member 'AutoSpriteAtlasSettings_GetInstance::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(PaperSpriteBlueprintLibrary_MakeBrushFromSprite) == 0x000120, "Wrong size on PaperSpriteBlueprintLibrary_MakeBrushFromSprite");
