...
public:
	...
	float                                         CursorRadius;                                      // 0x0014(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         HoverSlowdownFactor;                               // 0x0018(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ScrollDeadZone;                                    // 0x001C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ScrollUpdatePeriod;                                // 0x0020(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ScrollMultiplier;                                  // 0x0024(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCommonAnalogCursorSettings) == 0x000004, "Wrong alignment on FCommonAnalogCursorSettings");
static_assert(sizeof(FCommonAnalogCursorSettings) == 0x000028, "Wrong size on FCommonAnalogCursorSettings");
...
static_assert(offsetof(FCommonAnalogCursorSettings, CursorRadius) == 0x000014, "Member 'FCommonAnalogCursorSettings::CursorRadius' has a wrong offset!");
static_assert(offsetof(FCommonAnalogCursorSettings, HoverSlowdownFactor) == 0x000018, "Member 'FCommonAnalogCursorSettings::HoverSlowdownFactor' has a wrong offset!");
static_assert(offsetof(FCommonAnalogCursorSettings, ScrollDeadZone) == 0x00001C, "Member 'FCommonAnalogCursorSettings::ScrollDeadZone' has a wrong offset!");
static_assert(offsetof(FCommonAnalogCursorSettings, ScrollUpdatePeriod) == 0x000020, "Member 'FCommonAnalogCursorSettings::ScrollUpdatePeriod' has a wrong offset!");
static_assert(offsetof(FCommonAnalogCursorSettings, ScrollMultiplier) == 0x000024, "Member 'FCommonAnalogCursorSettings::ScrollMultiplier' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            OverrideBrush;                                     // 0x0020(0x0110)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FCommonInputTypeInfo) == 0x000010, "Wrong alignment on FCommonInputTypeInfo");
static_assert(sizeof(FCommonInputTypeInfo) == 0x000130, "Wrong size on FCommonInputTypeInfo");
...
public:
	...
	struct FCommonInputTypeInfo                   KeyboardInputTypeInfo;                             // 0x0040(0x0130)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   DefaultGamepadInputTypeInfo;                       // 0x0170(0x0130)(Edit, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FCommonInputTypeInfo> GamepadInputOverrides;                            // 0x02A0(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   TouchInputTypeInfo;                                // 0x02F0(0x0130)(Edit, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FCommonInputActionDataBase) == 0x000010, "Wrong alignment on FCommonInputActionDataBase");
static_assert(sizeof(FCommonInputActionDataBase) == 0x000420, "Wrong size on FCommonInputActionDataBase");
...
static_assert(offsetof(FCommonInputActionDataBase, DefaultGamepadInputTypeInfo) == 0x000170, "Member 'FCommonInputActionDataBase::DefaultGamepadInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, GamepadInputOverrides) == 0x0002A0, "Member 'FCommonInputActionDataBase::GamepadInputOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionDataBase, TouchInputTypeInfo) == 0x0002F0, "Member 'FCommonInputActionDataBase::TouchInputTypeInfo' has a wrong offset!");
