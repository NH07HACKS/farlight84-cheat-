...
#include "EQC_FishingTarget_classes.hpp"
#include "EQC_FishingTarget_parameters.hpp"
...
void UEQC_FishingTarget_C::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct FVector* ResultingLocation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQC_FishingTarget_C", "ProvideSingleLocation");

	Params::EQC_FishingTarget_C_ProvideSingleLocation Parms{};
