...
public:
	...
	uint32                                        MaxStreamRequestSizeKB;                            // 0x0150(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAnimationCompressionLibraryDatabase) == 0x000158, "Wrong size on UAnimationCompressionLibraryDatabase");
...
static_assert(offsetof(UAnimationCompressionLibraryDatabase, MaxStreamRequestSizeKB) == 0x000150, "Member 'UAnimationCompressionLibraryDatabase::MaxStreamRequestSizeKB' has a wrong offset!");
