...
public:
	...
	struct FCommonInputPlatformBaseData           CurrentPlatform;                                   // 0x00C8(0x0048)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonInputSettings) == 0x000110, "Wrong size on UCommonInputSettings");
...
public:
	void SetCanChangeInputMethod(const bool bCanChange);
