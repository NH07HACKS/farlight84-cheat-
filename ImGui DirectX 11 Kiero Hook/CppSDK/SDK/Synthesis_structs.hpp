...
public:
	...
	struct FSlateBrush                            NormalThumbImage;                                  // 0x0010(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            DisabledThumbImage;                                // 0x0120(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            NormalBarImage;                                    // 0x0230(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            DisabledBarImage;                                  // 0x0340(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundImage;                                   // 0x0450(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	float                                         BarThickness;                                      // 0x0560(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSynth2DSliderStyle) == 0x000570, "Wrong size on FSynth2DSliderStyle");
...
static_assert(offsetof(FSynth2DSliderStyle, DisabledThumbImage) == 0x000120, "Member 'FSynth2DSliderStyle::DisabledThumbImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, NormalBarImage) == 0x000230, "Member 'FSynth2DSliderStyle::NormalBarImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, DisabledBarImage) == 0x000340, "Member 'FSynth2DSliderStyle::DisabledBarImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, BackgroundImage) == 0x000450, "Member 'FSynth2DSliderStyle::BackgroundImage' has a wrong offset!");
static_assert(offsetof(FSynth2DSliderStyle, BarThickness) == 0x000560, "Member 'FSynth2DSliderStyle::BarThickness' has a wrong offset!");
...
public:
	uint8                                         Pad_8[0x8];                                        // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateBrush                            LargeKnob;                                         // 0x0010(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            LargeKnobOverlay;                                  // 0x0120(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            MediumKnob;                                        // 0x0230(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            MediumKnobOverlay;                                 // 0x0340(0x0110)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	float                                         MinValueAngle;                                     // 0x0450(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxValueAngle;                                     // 0x0454(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESynthKnobSize                                KnobSize;                                          // 0x0458(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSynthKnobStyle) == 0x000460, "Wrong size on FSynthKnobStyle");
static_assert(offsetof(FSynthKnobStyle, LargeKnob) == 0x000010, "Member 'FSynthKnobStyle::LargeKnob' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, LargeKnobOverlay) == 0x000120, "Member 'FSynthKnobStyle::LargeKnobOverlay' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MediumKnob) == 0x000230, "Member 'FSynthKnobStyle::MediumKnob' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MediumKnobOverlay) == 0x000340, "Member 'FSynthKnobStyle::MediumKnobOverlay' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MinValueAngle) == 0x000450, "Member 'FSynthKnobStyle::MinValueAngle' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, MaxValueAngle) == 0x000454, "Member 'FSynthKnobStyle::MaxValueAngle' has a wrong offset!");
static_assert(offsetof(FSynthKnobStyle, KnobSize) == 0x000458, "Member 'FSynthKnobStyle::KnobSize' has a wrong offset!");
