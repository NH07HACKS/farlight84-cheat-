...
class USceneComponentTransformStandIn : public UObject
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SceneComponentTransformStandIn">();
	}
	static class USceneComponentTransformStandIn* GetDefaultObj()
	{
		return GetDefaultObjImpl<USceneComponentTransformStandIn>();
	}
};
static_assert(alignof(USceneComponentTransformStandIn) == 0x000008, "Wrong alignment on USceneComponentTransformStandIn");
static_assert(sizeof(USceneComponentTransformStandIn) == 0x000060, "Wrong size on USceneComponentTransformStandIn");
