...
struct FSelectInstanceInfo final
{
public:
	int32                                         instanceID;                                        // 0x0000(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSelectInstanceInfo) == 0x000010, "Wrong alignment on FSelectInstanceInfo");
static_assert(sizeof(FSelectInstanceInfo) == 0x000050, "Wrong size on FSelectInstanceInfo");
static_assert(offsetof(FSelectInstanceInfo, instanceID) == 0x000000, "Member 'FSelectInstanceInfo::instanceID' has a wrong offset!");
static_assert(offsetof(FSelectInstanceInfo, Transform) == 0x000010, "Member 'FSelectInstanceInfo::Transform' has a wrong offset!");
static_assert(offsetof(FSelectInstanceInfo, CustomData) == 0x000040, "Member 'FSelectInstanceInfo::CustomData' has a wrong offset!");
