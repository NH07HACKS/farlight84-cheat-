...
// Function MovieSceneCapture.MovieSceneBlueprintLibrary.Initialize
// 0x0020 (0x0020 - 0x0000)
struct MovieSceneBlueprintLibrary_Initialize final
{
public:
	class FString                                 OutputFile;                                        // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FrameRate;                                         // 0x0010(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CompressQuality;                                   // 0x0014(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0018(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(MovieSceneBlueprintLibrary_Initialize) == 0x000008, "Wrong alignment on MovieSceneBlueprintLibrary_Initialize");
static_assert(sizeof(MovieSceneBlueprintLibrary_Initialize) == 0x000020, "Wrong size on MovieSceneBlueprintLibrary_Initialize");
static_assert(offsetof(MovieSceneBlueprintLibrary_Initialize, OutputFile) == 0x000000, "Member 'MovieSceneBlueprintLibrary_Initialize::OutputFile' has a wrong offset!");
static_assert(offsetof(MovieSceneBlueprintLibrary_Initialize, FrameRate) == 0x000010, "Member 'MovieSceneBlueprintLibrary_Initialize::FrameRate' has a wrong offset!");
static_assert(offsetof(MovieSceneBlueprintLibrary_Initialize, CompressQuality) == 0x000014, "Member 'MovieSceneBlueprintLibrary_Initialize::CompressQuality' has a wrong offset!");
static_assert(offsetof(MovieSceneBlueprintLibrary_Initialize, ReturnValue) == 0x000018, "Member 'MovieSceneBlueprintLibrary_Initialize::ReturnValue' has a wrong offset!");

// Function MovieSceneCapture.MovieSceneBlueprintLibrary.StartCapture
// 0x0001 (0x0001 - 0x0000)
struct MovieSceneBlueprintLibrary_StartCapture final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MovieSceneBlueprintLibrary_StartCapture) == 0x000001, "Wrong alignment on MovieSceneBlueprintLibrary_StartCapture");
static_assert(sizeof(MovieSceneBlueprintLibrary_StartCapture) == 0x000001, "Wrong size on MovieSceneBlueprintLibrary_StartCapture");
static_assert(offsetof(MovieSceneBlueprintLibrary_StartCapture, ReturnValue) == 0x000000, "Member 'MovieSceneBlueprintLibrary_StartCapture::ReturnValue' has a wrong offset!");
