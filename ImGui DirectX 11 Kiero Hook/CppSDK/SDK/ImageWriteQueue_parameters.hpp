...
public:
	...
	bool                                          LinearToGamma;                                     // 0x0080(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ImageWriteBlueprintLibrary_ExportToDisk) == 0x000090, "Wrong size on ImageWriteBlueprintLibrary_ExportToDisk");
...
static_assert(offsetof(ImageWriteBlueprintLibrary_ExportToDisk, LinearToGamma) == 0x000080, "Member 'ImageWriteBlueprintLibrary_ExportToDisk::LinearToGamma' has a wrong offset!");
