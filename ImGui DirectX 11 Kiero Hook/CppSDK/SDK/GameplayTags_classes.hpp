...
static_assert(sizeof(UGameplayTagsList) == 0x000098, "Wrong size on UGameplayTagsList");
...
{
public:
	bool                                          ImportTagsFromConfig;                              // 0x0098(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          WarnOnInvalidTags;                                 // 0x0099(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          FastReplication;                                   // 0x009A(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9B[0x5];                                       // 0x009B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 InvalidTagCharacters;                              // 0x00A0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTagCategoryRemap>      CategoryRemapping;                                 // 0x00B0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSoftObjectPath>                GameplayTagTableList;                              // 0x00C0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTagRedirect>           GameplayTagRedirects;                              // 0x00D0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           CommonlyReplicatedTags;                            // 0x00E0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumBitsForContainerSize;                           // 0x00F0(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NetIndexFirstBitSegment;                           // 0x00F4(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FRestrictedConfigInfo>          RestrictedConfigFiles;                             // 0x00F8(0x0010)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTagsSettings) == 0x000108, "Wrong size on UGameplayTagsSettings");
static_assert(offsetof(UGameplayTagsSettings, ImportTagsFromConfig) == 0x000098, "Member 'UGameplayTagsSettings::ImportTagsFromConfig' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, WarnOnInvalidTags) == 0x000099, "Member 'UGameplayTagsSettings::WarnOnInvalidTags' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, FastReplication) == 0x00009A, "Member 'UGameplayTagsSettings::FastReplication' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, InvalidTagCharacters) == 0x0000A0, "Member 'UGameplayTagsSettings::InvalidTagCharacters' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, CategoryRemapping) == 0x0000B0, "Member 'UGameplayTagsSettings::CategoryRemapping' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, GameplayTagTableList) == 0x0000C0, "Member 'UGameplayTagsSettings::GameplayTagTableList' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, GameplayTagRedirects) == 0x0000D0, "Member 'UGameplayTagsSettings::GameplayTagRedirects' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, CommonlyReplicatedTags) == 0x0000E0, "Member 'UGameplayTagsSettings::CommonlyReplicatedTags' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, NumBitsForContainerSize) == 0x0000F0, "Member 'UGameplayTagsSettings::NumBitsForContainerSize' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, NetIndexFirstBitSegment) == 0x0000F4, "Member 'UGameplayTagsSettings::NetIndexFirstBitSegment' has a wrong offset!");
static_assert(offsetof(UGameplayTagsSettings, RestrictedConfigFiles) == 0x0000F8, "Member 'UGameplayTagsSettings::RestrictedConfigFiles' has a wrong offset!");
