...
public:
	...
	uint8                                         BitPad_150_6 : 2;                                  // 0x0150(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	...
	uint8                                         Pad_274[0x24];                                     // 0x0274(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
...
// 0x0720 (0x09D0 - 0x02B0)
class UVehicleAnimInstance final : public UAnimInstance
{
public:
	uint8                                         Pad_2A8[0x718];                                    // 0x02A8(0x0718)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class USkeletalMeshComponent*                 Mesh;                                              // 0x0338(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWheeledVehicleMovementComponent*       VehicleMovement;                                   // 0x0340(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AWheeledVehicle) == 0x000348, "Wrong size on AWheeledVehicle");
static_assert(offsetof(AWheeledVehicle, Mesh) == 0x000338, "Member 'AWheeledVehicle::Mesh' has a wrong offset!");
static_assert(offsetof(AWheeledVehicle, VehicleMovement) == 0x000340, "Member 'AWheeledVehicle::VehicleMovement' has a wrong offset!");
