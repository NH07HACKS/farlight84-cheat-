...
public:
	...
	int32                                         LODThreshold;                                      // 0x0210(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         bUseOneMinusCurveValue : 1;                        // 0x0214(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(offsetof(FAnimNode_ControlRig, LODThreshold) == 0x000210, "Member 'FAnimNode_ControlRig::LODThreshold' has a wrong offset!");
...
static_assert(sizeof(FControlRigLayerInstanceProxy) == 0x000790, "Wrong size on FControlRigLayerInstanceProxy");
...
// 0x02A0 (0x0C30 - 0x0990)
struct FControlRigSequencerAnimInstanceProxy final : public FAnimSequencerInstanceProxy
{
public:
	uint8                                         Pad_990[0x2A0];                                    // 0x0990(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x000C30, "Wrong size on FControlRigSequencerAnimInstanceProxy");
...
static_assert(offsetof(FRigUnit_TransformConstraint, WorkData) == 0x000078, "Member 'FRigUnit_TransformConstraint::WorkData' has a wrong offset!");
