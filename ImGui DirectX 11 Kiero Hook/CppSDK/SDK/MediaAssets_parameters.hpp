...
// Function MediaAssets.MediaPlayer.SetCustomUniqueID
// 0x0004 (0x0004 - 0x0000)
struct MediaPlayer_SetCustomUniqueID final
{
public:
...
static_assert(alignof(MediaPlayer_SetCustomUniqueID) == 0x000004, "Wrong alignment on MediaPlayer_SetCustomUniqueID");
static_assert(sizeof(MediaPlayer_SetCustomUniqueID) == 0x000004, "Wrong size on MediaPlayer_SetCustomUniqueID");
static_assert(offsetof(MediaPlayer_SetCustomUniqueID, InUniqueID) == 0x000000, "Member 'MediaPlayer_SetCustomUniqueID::InUniqueID' has a wrong offset!");
...
// Function MediaAssets.MediaPlayer.GetCustomUniqueID
// 0x0004 (0x0004 - 0x0000)
struct MediaPlayer_GetCustomUniqueID final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_GetCustomUniqueID) == 0x000004, "Wrong alignment on MediaPlayer_GetCustomUniqueID");
static_assert(sizeof(MediaPlayer_GetCustomUniqueID) == 0x000004, "Wrong size on MediaPlayer_GetCustomUniqueID");
static_assert(offsetof(MediaPlayer_GetCustomUniqueID, ReturnValue) == 0x000000, "Member 'MediaPlayer_GetCustomUniqueID::ReturnValue' has a wrong offset!");
