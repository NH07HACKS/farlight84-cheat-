...
public:
	...
	int32                                         AssetId;                                           // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint32                                        SubAssetIndex;                                     // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        AssetCookCount;                                    // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHoudiniAssetBlueprintInstanceData) == 0x000110, "Wrong size on FHoudiniAssetBlueprintInstanceData");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, HoudiniAsset) == 0x000058, "Member 'FHoudiniAssetBlueprintInstanceData::HoudiniAsset' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, AssetId) == 0x000060, "Member 'FHoudiniAssetBlueprintInstanceData::AssetId' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, AssetState) == 0x000064, "Member 'FHoudiniAssetBlueprintInstanceData::AssetState' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, SubAssetIndex) == 0x000068, "Member 'FHoudiniAssetBlueprintInstanceData::SubAssetIndex' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, AssetCookCount) == 0x00006C, "Member 'FHoudiniAssetBlueprintInstanceData::AssetCookCount' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bHasBeenLoaded) == 0x000070, "Member 'FHoudiniAssetBlueprintInstanceData::bHasBeenLoaded' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bHasBeenDuplicated) == 0x000071, "Member 'FHoudiniAssetBlueprintInstanceData::bHasBeenDuplicated' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bPendingDelete) == 0x000072, "Member 'FHoudiniAssetBlueprintInstanceData::bPendingDelete' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bRecookRequested) == 0x000073, "Member 'FHoudiniAssetBlueprintInstanceData::bRecookRequested' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bRebuildRequested) == 0x000074, "Member 'FHoudiniAssetBlueprintInstanceData::bRebuildRequested' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bEnableCooking) == 0x000075, "Member 'FHoudiniAssetBlueprintInstanceData::bEnableCooking' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bForceNeedUpdate) == 0x000076, "Member 'FHoudiniAssetBlueprintInstanceData::bForceNeedUpdate' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bLastCookSuccess) == 0x000077, "Member 'FHoudiniAssetBlueprintInstanceData::bLastCookSuccess' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, ComponentGUID) == 0x000078, "Member 'FHoudiniAssetBlueprintInstanceData::ComponentGUID' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, HapiGUID) == 0x000088, "Member 'FHoudiniAssetBlueprintInstanceData::HapiGUID' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, bRegisteredComponentTemplate) == 0x000098, "Member 'FHoudiniAssetBlueprintInstanceData::bRegisteredComponentTemplate' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, SourceName) == 0x0000A0, "Member 'FHoudiniAssetBlueprintInstanceData::SourceName' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, Outputs) == 0x0000B0, "Member 'FHoudiniAssetBlueprintInstanceData::Outputs' has a wrong offset!");
static_assert(offsetof(FHoudiniAssetBlueprintInstanceData, Inputs) == 0x000100, "Member 'FHoudiniAssetBlueprintInstanceData::Inputs' has a wrong offset!");
...
public:
	...
	TArray<int64>                                 IntValues;                                         // 0x0030(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FHoudiniInputLandscapeTransferParams final
{
public:
	...
	TSet<class FName>                             HeightSpecifiedLayerNames;                         // 0x0008(0x0050)(Edit, NativeAccessSpecifierPublic)
	...
	TSet<class FName>                             LayerSpecifiedLayerNames;                          // 0x0068(0x0050)(Edit, NativeAccessSpecifierPublic)
...
static_assert(alignof(FHoudiniInputLandscapeTransferParams) == 0x000008, "Wrong alignment on FHoudiniInputLandscapeTransferParams");
static_assert(sizeof(FHoudiniInputLandscapeTransferParams) == 0x0000C8, "Wrong size on FHoudiniInputLandscapeTransferParams");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, TransferHeightMode) == 0x000000, "Member 'FHoudiniInputLandscapeTransferParams::TransferHeightMode' has a wrong offset!");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, HeightSpecifiedLayerNames) == 0x000008, "Member 'FHoudiniInputLandscapeTransferParams::HeightSpecifiedLayerNames' has a wrong offset!");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, HeightUnderSpecifiedLayerName) == 0x000058, "Member 'FHoudiniInputLandscapeTransferParams::HeightUnderSpecifiedLayerName' has a wrong offset!");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, TransferLayerMode) == 0x000060, "Member 'FHoudiniInputLandscapeTransferParams::TransferLayerMode' has a wrong offset!");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, LayerSpecifiedLayerNames) == 0x000068, "Member 'FHoudiniInputLandscapeTransferParams::LayerSpecifiedLayerNames' has a wrong offset!");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, LayerUnderSpecifiedLayerName) == 0x0000B8, "Member 'FHoudiniInputLandscapeTransferParams::LayerUnderSpecifiedLayerName' has a wrong offset!");
static_assert(offsetof(FHoudiniInputLandscapeTransferParams, bTransferWeightmap) == 0x0000C0, "Member 'FHoudiniInputLandscapeTransferParams::bTransferWeightmap' has a wrong offset!");
...
public:
	...
	TArray<TSoftObjectPtr<class UObject>>         VariationObjects;                                  // 0x0040(0x0010)(ZeroConstructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<int32>                                 TransformVariationIndices;                         // 0x0060(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<int32>                                 OriginalInstanceIndices;                           // 0x0070(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	int32                                         GeneratedLightMapResolution;                       // 0x0144(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	int32                                         GeneratedLightMapCoordinateIndex;                  // 0x0158(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bGeneratedUseMaximumStreamingTexelRatio : 1;       // 0x015C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FHoudiniStaticMeshGenerationProperties) == 0x000180, "Wrong size on FHoudiniStaticMeshGenerationProperties");
...
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedCollisionTraceFlag) == 0x000140, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedCollisionTraceFlag' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedLightMapResolution) == 0x000144, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedLightMapResolution' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedWalkableSlopeOverride) == 0x000148, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedWalkableSlopeOverride' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedLightMapCoordinateIndex) == 0x000158, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedLightMapCoordinateIndex' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedStreamingDistanceMultiplier) == 0x000160, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedStreamingDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedFoliageDefaultSettings) == 0x000168, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedFoliageDefaultSettings' has a wrong offset!");
static_assert(offsetof(FHoudiniStaticMeshGenerationProperties, GeneratedAssetUserData) == 0x000170, "Member 'FHoudiniStaticMeshGenerationProperties::GeneratedAssetUserData' has a wrong offset!");
...
public:
	...
	TArray<int32>                                 DisplayPointIndexDivider;                          // 0x0078(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FHoudiniSplineComponentInstanceData) == 0x000088, "Wrong size on FHoudiniSplineComponentInstanceData");
static_assert(offsetof(FHoudiniSplineComponentInstanceData, CurvePoints) == 0x000058, "Member 'FHoudiniSplineComponentInstanceData::CurvePoints' has a wrong offset!");
static_assert(offsetof(FHoudiniSplineComponentInstanceData, DisplayPoints) == 0x000068, "Member 'FHoudiniSplineComponentInstanceData::DisplayPoints' has a wrong offset!");
static_assert(offsetof(FHoudiniSplineComponentInstanceData, DisplayPointIndexDivider) == 0x000078, "Member 'FHoudiniSplineComponentInstanceData::DisplayPointIndexDivider' has a wrong offset!");
