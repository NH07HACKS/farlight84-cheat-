...
public:
	...
	EMakeMeshPivotLocation                        PivotLocation;                                     // 0x0063(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bAlignShapeToPlacementSurface;                     // 0x0068(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UProceduralShapeToolProperties, PivotLocation) == 0x000063, "Member 'UProceduralShapeToolProperties::PivotLocation' has a wrong offset!");
static_assert(offsetof(UProceduralShapeToolProperties, Rotation) == 0x000064, "Member 'UProceduralShapeToolProperties::Rotation' has a wrong offset!");
static_assert(offsetof(UProceduralShapeToolProperties, bAlignShapeToPlacementSurface) == 0x000068, "Member 'UProceduralShapeToolProperties::bAlignShapeToPlacementSurface' has a wrong offset!");
...
{
public:
	bool                                          bDeleteSourceActors;                               // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCombineMeshesToolProperties) == 0x000068, "Wrong size on UCombineMeshesToolProperties");
static_assert(offsetof(UCombineMeshesToolProperties, bDeleteSourceActors) == 0x000060, "Member 'UCombineMeshesToolProperties::bDeleteSourceActors' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_98[0x350];                                     // 0x0098(0x0350)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UConvertToPolygonsTool) == 0x0003E8, "Wrong size on UConvertToPolygonsTool");
...
// 0x0008 (0x0030 - 0x0028)
class UCSGMeshesToolBuilder final : public UInteractiveToolBuilder
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bDeleteInputActors;                                // 0x0061(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowTransformUI;                                  // 0x0062(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowNewBoundaryEdges;                             // 0x0063(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAttemptFixHoles;                                  // 0x0064(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_65[0x3];                                       // 0x0065(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UCSGMeshesToolProperties, bDeleteInputActors) == 0x000061, "Member 'UCSGMeshesToolProperties::bDeleteInputActors' has a wrong offset!");
static_assert(offsetof(UCSGMeshesToolProperties, bShowTransformUI) == 0x000062, "Member 'UCSGMeshesToolProperties::bShowTransformUI' has a wrong offset!");
static_assert(offsetof(UCSGMeshesToolProperties, bShowNewBoundaryEdges) == 0x000063, "Member 'UCSGMeshesToolProperties::bShowNewBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UCSGMeshesToolProperties, bAttemptFixHoles) == 0x000064, "Member 'UCSGMeshesToolProperties::bAttemptFixHoles' has a wrong offset!");

// Class MeshModelingTools.CSGMeshesTool
// 0x0070 (0x0100 - 0x0090)
class UCSGMeshesTool final : public UMultiSelectionTool
{
public:
	uint8                                         Pad_90[0x8];                                       // 0x0090(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCSGMeshesToolProperties*               CSGProperties;                                     // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UTransformProxy*>                TransformProxies;                                  // 0x00A8(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UTransformGizmo*>                TransformGizmos;                                   // 0x00B8(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_C8[0x10];                                      // 0x00C8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class ULineSetComponent*                      DrawnLineSet;                                      // 0x00D8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCSGMeshesTool) == 0x000100, "Wrong size on UCSGMeshesTool");
static_assert(offsetof(UCSGMeshesTool, Preview) == 0x000098, "Member 'UCSGMeshesTool::Preview' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, CSGProperties) == 0x0000A0, "Member 'UCSGMeshesTool::CSGProperties' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, TransformProxies) == 0x0000A8, "Member 'UCSGMeshesTool::TransformProxies' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, TransformGizmos) == 0x0000B8, "Member 'UCSGMeshesTool::TransformGizmos' has a wrong offset!");
static_assert(offsetof(UCSGMeshesTool, DrawnLineSet) == 0x0000D8, "Member 'UCSGMeshesTool::DrawnLineSet' has a wrong offset!");
...
public:
	...
	bool                                          bShowWireframe;                                    // 0x0065(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSnapToWorldGrid;                                  // 0x0066(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UDeformMeshPolygonsTransformProperties, bShowWireframe) == 0x000065, "Member 'UDeformMeshPolygonsTransformProperties::bShowWireframe' has a wrong offset!");
static_assert(offsetof(UDeformMeshPolygonsTransformProperties, bSnapToWorldGrid) == 0x000066, "Member 'UDeformMeshPolygonsTransformProperties::bSnapToWorldGrid' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_D8[0x1548];                                    // 0x00D8(0x1548)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDeformMeshPolygonsTool) == 0x001620, "Wrong size on UDeformMeshPolygonsTool");
...
public:
	...
	TArray<class FString>                         WeightMapsList;                                    // 0x0078(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FPerlinLayerProperties>         PerlinLayerProperties;                             // 0x0060(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_B0[0x348];                                     // 0x00B0(0x0348)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDisplaceMeshTool) == 0x0003F8, "Wrong size on UDisplaceMeshTool");
...
public:
	...
	uint8                                         Pad_168[0x378];                                    // 0x0168(0x0378)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlaneDistanceFromHitMechanic*          HeightMechanic;                                    // 0x04E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UDrawPolygonTool) == 0x000510, "Wrong size on UDrawPolygonTool");
...
static_assert(offsetof(UDrawPolygonTool, HeightMechanic) == 0x0004E0, "Member 'UDrawPolygonTool::HeightMechanic' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_168[0xB00];                                    // 0x0168(0x0B00)(Fixing Size After Last Property [ Dumper-7 ])
	class UTransformGizmo*                        PlaneTransformGizmo;                               // 0x0C68(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UTransformProxy*                        PlaneTransformProxy;                               // 0x0C70(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UDynamicMeshSculptTool) == 0x000C80, "Wrong size on UDynamicMeshSculptTool");
...
static_assert(offsetof(UDynamicMeshSculptTool, KelvinBrushProperties) == 0x0000E0, "Member 'UDynamicMeshSculptTool::KelvinBrushProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, RemeshProperties) == 0x0000E8, "Member 'UDynamicMeshSculptTool::RemeshProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, GizmoProperties) == 0x0000F0, "Member 'UDynamicMeshSculptTool::GizmoProperties' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, ViewProperties) == 0x0000F8, "Member 'UDynamicMeshSculptTool::ViewProperties' has a wrong offset!");
...
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformGizmo) == 0x000C68, "Member 'UDynamicMeshSculptTool::PlaneTransformGizmo' has a wrong offset!");
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformProxy) == 0x000C70, "Member 'UDynamicMeshSculptTool::PlaneTransformProxy' has a wrong offset!");
...
static_assert(sizeof(UPolyEditTransformProperties) == 0x000070, "Wrong size on UPolyEditTransformProperties");
static_assert(offsetof(UPolyEditTransformProperties, bShowWireframe) == 0x000060, "Member 'UPolyEditTransformProperties::bShowWireframe' has a wrong offset!");
static_assert(offsetof(UPolyEditTransformProperties, LocalFrameMode) == 0x000064, "Member 'UPolyEditTransformProperties::LocalFrameMode' has a wrong offset!");
static_assert(offsetof(UPolyEditTransformProperties, bLockRotation) == 0x000068, "Member 'UPolyEditTransformProperties::bLockRotation' has a wrong offset!");
static_assert(offsetof(UPolyEditTransformProperties, bSnapToWorldGrid) == 0x000069, "Member 'UPolyEditTransformProperties::bSnapToWorldGrid' has a wrong offset!");
...
public:
	...
	class UPolyEditCutProperties*                 CutProperties;                                     // 0x0110(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolyEditSetUVProperties*               SetUVProperties;                                   // 0x0118(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPolygonSelectionMechanic*              SelectionMechanic;                                 // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_128[0x8];                                      // 0x0128(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMultiTransformer*                      MultiTransformer;                                  // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_138[0x358];                                    // 0x0138(0x0358)(Fixing Size After Last Property [ Dumper-7 ])
	class UPolyEditPreviewMesh*                   EditPreview;                                       // 0x0490(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_498[0x8];                                      // 0x0498(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlaneDistanceFromHitMechanic*          ExtrudeHeightMechanic;                             // 0x04A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USpatialCurveDistanceMechanic*          CurveDistMechanic;                                 // 0x04A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCollectSurfacePathMechanic*            SurfacePathMechanic;                               // 0x04B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4B8[0x308];                                    // 0x04B8(0x0308)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditMeshPolygonsTool) == 0x0007C0, "Wrong size on UEditMeshPolygonsTool");
...
static_assert(offsetof(UEditMeshPolygonsTool, CutProperties) == 0x000110, "Member 'UEditMeshPolygonsTool::CutProperties' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, SetUVProperties) == 0x000118, "Member 'UEditMeshPolygonsTool::SetUVProperties' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, SelectionMechanic) == 0x000120, "Member 'UEditMeshPolygonsTool::SelectionMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, MultiTransformer) == 0x000130, "Member 'UEditMeshPolygonsTool::MultiTransformer' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, EditPreview) == 0x000490, "Member 'UEditMeshPolygonsTool::EditPreview' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, ExtrudeHeightMechanic) == 0x0004A0, "Member 'UEditMeshPolygonsTool::ExtrudeHeightMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, CurveDistMechanic) == 0x0004A8, "Member 'UEditMeshPolygonsTool::CurveDistMechanic' has a wrong offset!");
static_assert(offsetof(UEditMeshPolygonsTool, SurfacePathMechanic) == 0x0004B0, "Member 'UEditMeshPolygonsTool::SurfacePathMechanic' has a wrong offset!");

// Class MeshModelingTools.WeldMeshEdgesTool
// 0x0280 (0x0308 - 0x0088)
...
public:
	...
	uint8                                         Pad_8D[0x27B];                                     // 0x008D(0x027B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWeldMeshEdgesTool) == 0x000308, "Wrong size on UWeldMeshEdgesTool");
...
static_assert(sizeof(UVertexBrushSculptProperties) == 0x000070, "Wrong size on UVertexBrushSculptProperties");
...
static_assert(offsetof(UVertexBrushSculptProperties, PrimaryBrushSpeed) == 0x000064, "Member 'UVertexBrushSculptProperties::PrimaryBrushSpeed' has a wrong offset!");
static_assert(offsetof(UVertexBrushSculptProperties, bPreserveUVFlow) == 0x000068, "Member 'UVertexBrushSculptProperties::bPreserveUVFlow' has a wrong offset!");
static_assert(offsetof(UVertexBrushSculptProperties, bFreezeTarget) == 0x000069, "Member 'UVertexBrushSculptProperties::bFreezeTarget' has a wrong offset!");
static_assert(offsetof(UVertexBrushSculptProperties, SmoothBrushSpeed) == 0x00006C, "Member 'UVertexBrushSculptProperties::SmoothBrushSpeed' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_E8[0x278];                                     // 0x00E8(0x0278)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditUVIslandsTool) == 0x000360, "Wrong size on UEditUVIslandsTool");
...
public:
	...
	class UHoleFillToolProperties*                Properties;                                        // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UHoleFillToolActions*                   Actions;                                           // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPolygonSelectionMechanic*              SelectionMechanic;                                 // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_B8[0x370];                                     // 0x00B8(0x0370)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UHoleFillTool) == 0x000428, "Wrong size on UHoleFillTool");
static_assert(offsetof(UHoleFillTool, Properties) == 0x000098, "Member 'UHoleFillTool::Properties' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, Actions) == 0x0000A0, "Member 'UHoleFillTool::Actions' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, Preview) == 0x0000A8, "Member 'UHoleFillTool::Preview' has a wrong offset!");
static_assert(offsetof(UHoleFillTool, SelectionMechanic) == 0x0000B0, "Member 'UHoleFillTool::SelectionMechanic' has a wrong offset!");
...
{
public:
	TArray<class FName>                           Attributes;                                        // 0x0060(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	bool                                          bPolygonBorders;                                   // 0x0062(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUVSeams;                                          // 0x0063(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNormalSeams;                                      // 0x0064(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bNormalVectors;                                    // 0x0065(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTangentVectors;                                   // 0x0066(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_67[0x1];                                       // 0x0067(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         NormalLength;                                      // 0x0068(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TangentLength;                                     // 0x006C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMeshInspectorProperties) == 0x000070, "Wrong size on UMeshInspectorProperties");
...
static_assert(offsetof(UMeshInspectorProperties, bPolygonBorders) == 0x000062, "Member 'UMeshInspectorProperties::bPolygonBorders' has a wrong offset!");
static_assert(offsetof(UMeshInspectorProperties, bUVSeams) == 0x000063, "Member 'UMeshInspectorProperties::bUVSeams' has a wrong offset!");
static_assert(offsetof(UMeshInspectorProperties, bNormalSeams) == 0x000064, "Member 'UMeshInspectorProperties::bNormalSeams' has a wrong offset!");
static_assert(offsetof(UMeshInspectorProperties, bNormalVectors) == 0x000065, "Member 'UMeshInspectorProperties::bNormalVectors' has a wrong offset!");
static_assert(offsetof(UMeshInspectorProperties, bTangentVectors) == 0x000066, "Member 'UMeshInspectorProperties::bTangentVectors' has a wrong offset!");
static_assert(offsetof(UMeshInspectorProperties, NormalLength) == 0x000068, "Member 'UMeshInspectorProperties::NormalLength' has a wrong offset!");
static_assert(offsetof(UMeshInspectorProperties, TangentLength) == 0x00006C, "Member 'UMeshInspectorProperties::TangentLength' has a wrong offset!");
...
static_assert(sizeof(UMeshInspectorTool) == 0x0000F8, "Wrong size on UMeshInspectorTool");
...
{
public:
	class UMaterialInterface*                     Material;                                          // 0x0060(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USculptBrushProperties) == 0x000080, "Wrong size on USculptBrushProperties");
...
{
public:
	EPlaneBrushSideMode                           WhichSide;                                         // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPlaneBrushProperties) == 0x000068, "Wrong size on UPlaneBrushProperties");
static_assert(offsetof(UPlaneBrushProperties, WhichSide) == 0x000060, "Member 'UPlaneBrushProperties::WhichSide' has a wrong offset!");
...
public:
	...
	class USculptBrushProperties*                 BrushProperties;                                   // 0x0100(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWorkPlaneProperties*                   GizmoProperties;                                   // 0x0108(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_110[0x3C8];                                    // 0x0110(0x03C8)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshEditingViewProperties*             ViewProperties;                                    // 0x04D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInstanceDynamic*               ActiveOverrideMaterial;                            // 0x04E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UBrushStampIndicator*                   BrushIndicator;                                    // 0x04E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               BrushIndicatorMaterial;                            // 0x04F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPreviewMesh*                           BrushIndicatorMesh;                                // 0x04F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTransformGizmo*                        PlaneTransformGizmo;                               // 0x0500(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTransformProxy*                        PlaneTransformProxy;                               // 0x0508(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_510[0x128];                                    // 0x0510(0x0128)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshSculptToolBase) == 0x000640, "Wrong size on UMeshSculptToolBase");
...
static_assert(offsetof(UMeshSculptToolBase, ViewProperties) == 0x0004D8, "Member 'UMeshSculptToolBase::ViewProperties' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, ActiveOverrideMaterial) == 0x0004E0, "Member 'UMeshSculptToolBase::ActiveOverrideMaterial' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, BrushIndicator) == 0x0004E8, "Member 'UMeshSculptToolBase::BrushIndicator' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, BrushIndicatorMaterial) == 0x0004F0, "Member 'UMeshSculptToolBase::BrushIndicatorMaterial' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, BrushIndicatorMesh) == 0x0004F8, "Member 'UMeshSculptToolBase::BrushIndicatorMesh' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, PlaneTransformGizmo) == 0x000500, "Member 'UMeshSculptToolBase::PlaneTransformGizmo' has a wrong offset!");
static_assert(offsetof(UMeshSculptToolBase, PlaneTransformProxy) == 0x000508, "Member 'UMeshSculptToolBase::PlaneTransformProxy' has a wrong offset!");
...
// 0x0A90 (0x10D0 - 0x0640)
class UMeshVertexSculptTool final : public UMeshSculptToolBase
{
public:
	class UVertexBrushSculptProperties*           SculptProperties;                                  // 0x0638(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UPlaneBrushProperties*                  PlaneBrushProperties;                              // 0x0640(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USculptMaxBrushProperties*              SculptMaxBrushProperties;                          // 0x0648(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USimpleDynamicMeshComponent*            DynamicMeshComponent;                              // 0x0650(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_658[0xA78];                                    // 0x0658(0x0A78)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMeshVertexSculptTool) == 0x0010D0, "Wrong size on UMeshVertexSculptTool");
static_assert(offsetof(UMeshVertexSculptTool, SculptProperties) == 0x000638, "Member 'UMeshVertexSculptTool::SculptProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, PlaneBrushProperties) == 0x000640, "Member 'UMeshVertexSculptTool::PlaneBrushProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, SculptMaxBrushProperties) == 0x000648, "Member 'UMeshVertexSculptTool::SculptMaxBrushProperties' has a wrong offset!");
static_assert(offsetof(UMeshVertexSculptTool, DynamicMeshComponent) == 0x000650, "Member 'UMeshVertexSculptTool::DynamicMeshComponent' has a wrong offset!");
...
class URemeshMeshTool final : public USingleSelectionTool
{
public:
	uint8                                         Pad_88[0x8];                                       // 0x0088(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URemeshMeshTool) == 0x0000E0, "Wrong size on URemeshMeshTool");
...
// 0x0008 (0x0030 - 0x0028)
class USelfUnionMeshesToolBuilder final : public UInteractiveToolBuilder
{
public:
	uint8                                         Pad_28[0x8];                                       // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	bool                                          bDeleteInputActors;                                // 0x0060(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAttemptFixHoles;                                  // 0x0061(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowNewBoundaryEdges;                             // 0x0062(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_63[0x5];                                       // 0x0063(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USelfUnionMeshesToolProperties) == 0x000068, "Wrong size on USelfUnionMeshesToolProperties");
static_assert(offsetof(USelfUnionMeshesToolProperties, bDeleteInputActors) == 0x000060, "Member 'USelfUnionMeshesToolProperties::bDeleteInputActors' has a wrong offset!");
static_assert(offsetof(USelfUnionMeshesToolProperties, bAttemptFixHoles) == 0x000061, "Member 'USelfUnionMeshesToolProperties::bAttemptFixHoles' has a wrong offset!");
static_assert(offsetof(USelfUnionMeshesToolProperties, bShowNewBoundaryEdges) == 0x000062, "Member 'USelfUnionMeshesToolProperties::bShowNewBoundaryEdges' has a wrong offset!");

// Class MeshModelingTools.SelfUnionMeshesTool
// 0x0050 (0x00E0 - 0x0090)
class USelfUnionMeshesTool final : public UMultiSelectionTool
{
public:
	uint8                                         Pad_90[0x8];                                       // 0x0090(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UMeshOpPreviewWithBackgroundCompute*    Preview;                                           // 0x0098(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USelfUnionMeshesToolProperties*         Properties;                                        // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULineSetComponent*                      DrawnLineSet;                                      // 0x00A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USelfUnionMeshesTool) == 0x0000E0, "Wrong size on USelfUnionMeshesTool");
static_assert(offsetof(USelfUnionMeshesTool, Preview) == 0x000098, "Member 'USelfUnionMeshesTool::Preview' has a wrong offset!");
static_assert(offsetof(USelfUnionMeshesTool, Properties) == 0x0000A0, "Member 'USelfUnionMeshesTool::Properties' has a wrong offset!");
static_assert(offsetof(USelfUnionMeshesTool, DrawnLineSet) == 0x0000A8, "Member 'USelfUnionMeshesTool::DrawnLineSet' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_A8[0x278];                                     // 0x00A8(0x0278)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USmoothMeshTool) == 0x000320, "Wrong size on USmoothMeshTool");
