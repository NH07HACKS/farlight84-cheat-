...
// Parameters:
// class UAutoSpriteAtlasSettings*         ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UAutoSpriteAtlasSettings* UAutoSpriteAtlasSettings::GetInstance()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("AutoSpriteAtlasSettings", "GetInstance");

	Params::AutoSpriteAtlasSettings_GetInstance Parms{};
